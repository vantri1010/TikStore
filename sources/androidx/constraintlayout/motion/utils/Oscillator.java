...
public class Oscillator {
    ...
    public void normalize() {
        double totalArea = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        double totalCount = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        int i = 0;
        while (true) {
    ...
    public double getP(double time) {
        ...
        if (time < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            time2 = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        } else if (time > 1.0d) {
            time2 = 1.0d;
        } else {
            time2 = time;
