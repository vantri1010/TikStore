...
public class Debug {
    public static void logStack(String tag, String msg, int n) {
        ...
        for (int i = 1; i <= n2; i++) {
            ...
            s = s + " ";
            Log.v(tag, msg + s + (".(" + st[i].getFileName() + LogUtils.COLON + st[i].getLineNumber() + ") " + st[i].getMethodName()) + s);
        }
    }
    ...
    public static void printStack(String msg, int n) {
        ...
        for (int i = 1; i <= n2; i++) {
            ...
            printStream.println(msg + s + (".(" + st[i].getFileName() + LogUtils.COLON + st[i].getLineNumber() + ") ") + s);
        }
    }
    ...
    public static void dumpPoc(Object obj) {
        ...
        String loc = ".(" + s.getFileName() + LogUtils.COLON + s.getLineNumber() + SQLBuilder.PARENTHESES_RIGHT;
    ...
    public static String getLocation() {
        StackTraceElement s = new Throwable().getStackTrace()[1];
        return ".(" + s.getFileName() + LogUtils.COLON + s.getLineNumber() + SQLBuilder.PARENTHESES_RIGHT;
    }

    public static String getLoc() {
        StackTraceElement s = new Throwable().getStackTrace()[1];
        return ".(" + s.getFileName() + LogUtils.COLON + s.getLineNumber() + ") " + s.getMethodName() + "()";
    }
    ...
    public static void dumpLayoutParams(ViewGroup layout, String str) {
        StackTraceElement s = new Throwable().getStackTrace()[1];
        String loc = ".(" + s.getFileName() + LogUtils.COLON + s.getLineNumber() + ") " + str + "  ";
