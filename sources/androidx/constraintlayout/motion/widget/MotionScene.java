...
public class MotionScene {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00b5, code lost:
        ...
        r7 = r1.getLineNumber();
        android.util.Log.v(TAG, " OnSwipe (" + r6 + ".xml:" + r7 + com.litesuits.orm.db.assit.SQLBuilder.PARENTHESES_RIGHT);
     */
    ...
    private int getId(Context context, String idString) {
        ...
        if (idString.contains("/")) {
            id = context.getResources().getIdentifier(idString.substring(idString.indexOf(47) + 1), TtmlNode.ATTR_ID, context.getPackageName());
    ...
    private void parseConstraintSet(Context context, XmlPullParser parser) {
        ...
        while (true) {
            ...
            if (hashCode != -1496482599) {
                if (hashCode == 3355 && name.equals(TtmlNode.ATTR_ID)) {
                    c = 0;
                }
    ...
    public void processTouchEvent(MotionEvent event, int currentState, MotionLayout motionLayout) {
        ...
        if (currentState != -1) {
            ...
            if (action == 0) {
                ...
                if ((((double) dx) != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || ((double) dy) != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) && (motionEvent = this.mLastTouchDown) != null) {
