...
public abstract class VersionedParcel {
    ...
    private void writeSerializable(Serializable s) {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException writing serializable object (name = " + name + SQLBuilder.PARENTHESES_RIGHT, ioe);
        }
    }
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + name + SQLBuilder.PARENTHESES_RIGHT, ioe);
        } catch (ClassNotFoundException cnfe) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + name + SQLBuilder.PARENTHESES_RIGHT, cnfe);
        }
    }
