    ...
    private static class KeyboardStatusListener implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        private void calculateKeyboardHeight(int displayHeight) {
            ...
            if (keyboardHeight > KeyboardUtil.getMinKeyboardHeight(getContext())) {
                ...
                } else if (KeyboardUtil.saveKeyboardHeight(getContext(), keyboardHeight) && this.panelHeightTarget.getHeight() != (validPanelHeight = KeyboardUtil.getValidPanelHeight(getContext()))) {
            ...
            if (!KPSwitchConflictUtil.isHandleByPlaceholder(this.isFullScreen, this.isTranslucentStatus, this.isFitSystemWindows)) {
                ...
                if (this.isTranslucentStatus || phoneDisplayHeight != actionBarOverlayLayoutHeight) {
                    ...
                    if (i == 0) {
                        ...
                        isKeyboardShowing2 = displayHeight < i - KeyboardUtil.getMinKeyboardHeight(getContext());
                    }
