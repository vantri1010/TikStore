...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    public static final <T> T parseObject(String text, Class<T> clazz, ParseProcess processor, Feature... features) {
        return parseObject(text, clazz, ParserConfig.getGlobalInstance(), processor, DEFAULT_PARSER_FEATURE, features);
    }
    ...
    public static final Object toJSON(Object javaObject, ParserConfig mapping) {
        ...
        if (javaObject instanceof Map) {
            ...
            if (clazz.isArray()) {
                ...
                try {
                    List<FieldInfo> getters = TypeUtils.computeGetters(clazz, (Map<String, String>) null);
