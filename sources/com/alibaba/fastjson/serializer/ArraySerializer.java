            ...
            try {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (item == null) {
                        ...
                        this.compObjectSerializer.write(serializer, item, Integer.valueOf(i), (Type) null);
                    } else {
                        serializer.getObjectWriter(item.getClass()).write(serializer, item, Integer.valueOf(i), (Type) null);
                    }
                }
                out.append(']');
            } finally {
