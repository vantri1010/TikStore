...
public interface IComOpenClient extends IInterface {
    ...
    public static abstract class a extends Binder implements IComOpenClient {
        ...
        private static class C0014a implements IComOpenClient {
            private IBinder a;
        ...
        public static IComOpenClient a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IComOpenClient)) ? new C0014a(iBinder) : (IComOpenClient) queryLocalInterface;
        }
