...
public class ad {
    private static final String t = ad.class.getSimpleName();
    ...
    public Bundle a(e eVar) {
        ...
        int i3 = this.f;
        if (i3 >= 0 && this.g >= 0 && i3 <= this.j.right && this.g <= this.j.bottom && this.j.right > 0 && this.j.bottom > 0) {
            int i4 = this.f - ((this.j.right - this.j.left) / 2);
            int i5 = this.g - ((this.j.bottom - this.j.top) / 2);
            long j2 = (long) i4;
            this.h = j2;
            this.i = (long) (-i5);
    ...
    public void a(Bundle bundle) {
        ...
        if (!(this.j.right == 0 || this.j.bottom == 0)) {
            int i2 = (int) this.h;
            int i3 = (int) (-this.i);
            this.f = i2 + ((this.j.right - this.j.left) / 2);
            this.g = i3 + ((this.j.bottom - this.j.top) / 2);
        }
