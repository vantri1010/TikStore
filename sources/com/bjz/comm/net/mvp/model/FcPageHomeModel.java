...
public class FcPageHomeModel implements BaseFcContract.IFcPageHomeModel {
    private static final String TAG = FcPageHomeModel.class.getSimpleName();

    public void getFcList(int limit, long forumID, DataListener<BResponse<ArrayList<RespFcListBean>>> listener) {
        Observable<BResponse<ArrayList<RespFcListBean>>> observable = ApiFactory.getInstance().getApiMomentForum().getHomePageFriendsList(limit, forumID);
