...
public class FcPageFollowedPresenter implements BaseFcContract.IFcPageFollowedPresenter {
    ...
    private FcPageFollowedModel model = null;
    ...
    public void getFcList(int limit, long forumID) {
        this.model.getFcList(limit, forumID, new DataListener<BResponse<ArrayList<RespFcListBean>>>() {
            public void onResponse(BResponse<ArrayList<RespFcListBean>> result) {
                if (result == null) {
                    FcPageFollowedPresenter.this.mView.getFcListFailed((String) null);
                } else if (result.isState()) {
                    FcPageFollowedPresenter.this.mView.getFcListSucc(result.Data == null ? new ArrayList() : (ArrayList) result.Data);
                } else {
