...
public final class IsoTypeReader {
    public static long readUInt32BE(ByteBuffer bb) {
        return (((long) readUInt8(bb)) << 24) + (((long) readUInt8(bb)) << 16) + (((long) readUInt8(bb)) << 8) + (((long) readUInt8(bb)) << 0);
    }
    ...
    public static float readFixedPoint88(ByteBuffer bb) {
        ...
        bb.get(bytes);
        return ((float) ((short) ((bytes[1] & UByte.MAX_VALUE) | ((short) (((bytes[0] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | 0))))) / 256.0f;
    }
