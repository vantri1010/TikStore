...
public class TextSampleEntry extends AbstractSampleEntry {
    ...
    public static class StyleRecord {
        ...
        public int hashCode() {
            int result = ((((((((this.startChar * 31) + this.endChar) * 31) + this.fontId) * 31) + this.faceStyleFlags) * 31) + this.fontSize) * 31;
            int[] iArr = this.textColor;
            return result + (iArr != null ? Arrays.hashCode(iArr) : 0);
        }
    ...
    public long getSize() {
        ...
        return s + 38 + ((long) ((this.largeBox || s + 38 >= 4294967296L) ? 16 : 8));
    }
}
