...
public abstract class zzy {
    ...
    public enum zzb {
        ...
        static {
            ...
            zzb zzb = new zzb("COMBINED", 20, 100);
            COMBINED = zzb;
            zzb[] zzbArr = {UNKNOWN_MOBILE_SUBTYPE, GPRS, EDGE, UMTS, CDMA, EVDO_0, EVDO_A, RTT, HSDPA, HSUPA, HSPA, IDEN, EVDO_B, LTE, EHRPD, HSPAP, GSM, TD_SCDMA, IWLAN, LTE_CA, zzb};
    ...
    public enum zzc {
        ...
        static {
            ...
            zzc zzc = new zzc("NONE", 18, -1);
            NONE = zzc;
            zzc[] zzcArr = {MOBILE, zzb, MOBILE_MMS, MOBILE_SUPL, MOBILE_DUN, MOBILE_HIPRI, WIMAX, BLUETOOTH, DUMMY, ETHERNET, MOBILE_FOTA, MOBILE_IMS, MOBILE_CBS, WIFI_P2P, MOBILE_IA, MOBILE_EMERGENCY, PROXY, VPN, zzc};
