...
final class MediaPeriodHolder {
    ...
    public MediaPeriodHolder(RendererCapabilities[] rendererCapabilities2, long rendererPositionOffsetUs2, TrackSelector trackSelector2, Allocator allocator, MediaSource mediaSource2, MediaPeriodInfo info2) {
        ...
        this.mediaPeriod = createMediaPeriod(info2.id, mediaSource2, allocator, info2.startPositionUs);
    }
    ...
    private static MediaPeriod createMediaPeriod(MediaSource.MediaPeriodId id, MediaSource mediaSource2, Allocator allocator, long startPositionUs) {
        ...
        return new ClippingMediaPeriod(mediaPeriod2, true, 0, id.endPositionUs);
    }

    private static void releaseMediaPeriod(MediaSource.MediaPeriodId id, MediaSource mediaSource2, MediaPeriod mediaPeriod2) {
        try {
            if (id.endPositionUs == C.TIME_UNSET || id.endPositionUs == Long.MIN_VALUE) {
