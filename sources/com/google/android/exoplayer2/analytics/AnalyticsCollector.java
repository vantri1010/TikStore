...
public class AnalyticsCollector implements Player.EventListener, MetadataOutput, AudioRendererEventListener, VideoRendererEventListener, MediaSourceEventListener, BandwidthMeter.EventListener, DefaultDrmSessionEventListener, VideoListener, AudioListener {
    ...
    public AnalyticsListener.EventTime generateEventTime(Timeline timeline, int windowIndex, MediaSource.MediaPeriodId mediaPeriodId) {
    ...
    private AnalyticsListener.EventTime generateEventTime(MediaPeriodInfo mediaPeriodInfo) {
        ...
        if (mediaPeriodInfo != null || (mediaPeriodInfo = this.mediaPeriodQueueTracker.tryResolveWindowIndex(windowIndex)) != null) {
        ...
        return generateEventTime(windowIndex < timeline.getWindowCount() ? timeline : Timeline.EMPTY, (windowIndex = this.player.getCurrentWindowIndex()), (MediaSource.MediaPeriodId) null);
    }
    ...
    private AnalyticsListener.EventTime generateMediaPeriodEventTime(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        Timeline timeline = this.player.getCurrentTimeline();
        return generateEventTime(windowIndex < timeline.getWindowCount() ? timeline : Timeline.EMPTY, windowIndex, (MediaSource.MediaPeriodId) null);
    }
