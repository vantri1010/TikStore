...
final class AudioTrackPositionTracker {
    ...
    public void setAudioTrack(AudioTrack audioTrack2, int outputEncoding, int outputPcmFrameSize2, int bufferSize2) {
        ...
        this.bufferSizeUs = isEncodingLinearPcm ? framesToDurationUs((long) (bufferSize2 / outputPcmFrameSize2)) : -9223372036854775807L;
    ...
    public boolean mayHandleBuffer(long writtenFrames) {
        ...
        if (hadData && !hasPendingData && playState != 1 && (listener2 = this.listener) != null) {
