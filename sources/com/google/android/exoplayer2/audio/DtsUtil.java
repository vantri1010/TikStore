...
public final class DtsUtil {
    ...
    private static final int[] SAMPLE_RATE_BY_SFREQ = {-1, 8000, AudioEditConstant.ExportSampleRate, 32000, -1, -1, 11025, 22050, 44100, -1, -1, 12000, 24000, 48000, -1, -1};
    ...
    private static final int[] TWICE_BITRATE_KBPS_BY_RATE = {64, 112, 128, PsExtractor.AUDIO_STREAM, 224, 256, 384, 448, 512, UVCCamera.DEFAULT_PREVIEW_WIDTH, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    ...
    public static Format parseDtsFormat(byte[] frame, String trackId, String language, DrmInitData drmInitData) {
        ...
        int i = rate;
        return Format.createAudioSampleFormat(trackId, MimeTypes.AUDIO_DTS, (String) null, bitrate, -1, channelCount + (frameBits.readBits(2) > 0 ? 1 : 0), sampleRate, (List<byte[]>) null, drmInitData, 0, language);
    }
