...
final class Sonic {
    ...
    public Sonic(int inputSampleRateHz2, int channelCount2, float speed2, float pitch2, int outputSampleRateHz) {
        ...
        int i = inputSampleRateHz2 / 65;
        this.maxPeriod = i;
        int i2 = i * 2;
        this.maxRequiredFrameCount = i2;
        this.downSampleBuffer = new short[i2];
        this.inputBuffer = new short[(i2 * channelCount2)];
        this.outputBuffer = new short[(i2 * channelCount2)];
        this.pitchBuffer = new short[(i2 * channelCount2)];
    }
    ...
    public void queueInput(ShortBuffer buffer) {
        ...
        buffer.get(ensureSpaceForAdditionalFrames, this.inputFrameCount * this.channelCount, ((i * framesToWrite) * 2) / 2);
