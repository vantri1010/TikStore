...
class DefaultDrmSession<T extends ExoMediaCrypto> implements DrmSession<T> {
    ...
    private void onError(Exception e) {
        ...
        this.eventDispatcher.dispatch(new EventDispatcher.Event(e) {
