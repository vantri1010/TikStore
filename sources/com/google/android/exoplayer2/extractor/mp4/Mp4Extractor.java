...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    public SeekMap.SeekPoints getSeekPoints(long timeUs) {
        ...
        return new SeekMap.SeekPoints(firstSeekPoint, new SeekPoint(secondTimeUs, secondOffset));
    }
    ...
    private void processMoovAtom(Atom.ContainerAtom moov) throws ParserException {
        ...
        while (i < trackCount) {
            ...
            int i2 = maxInputSize;
            mp4Track.trackOutput.format(MetadataUtil.getFormatWithMetadata(track.type, track.format.copyWithMaxInputSize(maxInputSize), udtaMetadata, mdtaMetadata, gaplessInfoHolder));
            ...
            i++;
            Atom.ContainerAtom containerAtom2 = moov;
        ...
        Mp4Track[] mp4TrackArr = (Mp4Track[]) tracks2.toArray(new Mp4Track[0]);
    ...
    private ArrayList<TrackSampleTable> getTrackSampleTables(Atom.ContainerAtom moov, GaplessInfoHolder gaplessInfoHolder, boolean ignoreEditLists) throws ParserException {
        ...
        for (int i = 0; i < moov.containerChildren.size(); i++) {
            ...
            if (atom.type == Atom.TYPE_trak && (track = AtomParsers.parseTrak(atom, moov.getLeafAtomOfType(Atom.TYPE_mvhd), C.TIME_UNSET, (DrmInitData) null, ignoreEditLists, this.isQuickTime)) != null) {
