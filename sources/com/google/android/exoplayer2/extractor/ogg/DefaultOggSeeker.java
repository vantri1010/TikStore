        ...
        if (i == 0) {
            ...
            if (i == 2) {
                ...
                if (currentGranule == 0) {
                    ...
                    long currentGranule2 = getNextSeekPosition(currentGranule, input);
                    if (currentGranule2 >= 0) {
                        return currentGranule2;
                    }
                    position = skipToPageOfGranule(input, this.targetGranule, -(currentGranule2 + 2));
                }
                this.state = 3;
                return -(2 + position);
            } else if (i == 3) {
