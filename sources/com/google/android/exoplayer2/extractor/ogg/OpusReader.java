...
final class OpusReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray packet, long position, StreamReader.SetupData setupData) {
        ...
        if (!this.headerRead) {
            ...
            byte b = ((metadata[11] & UByte.MAX_VALUE) << 8) | (metadata[10] & UByte.MAX_VALUE);
            ...
            byte b2 = b;
            setupData.format = Format.createAudioSampleFormat((String) null, MimeTypes.AUDIO_OPUS, (String) null, -1, -1, metadata[9] & 255, SAMPLE_RATE, arrayList, (DrmInitData) null, 0, (String) null);
