...
public final class AdtsReader implements ElementaryStreamReader {
    ...
    public void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator idGenerator) {
        ...
        if (this.exposeId3) {
            ...
            track.format(Format.createSampleFormat(idGenerator.getFormatId(), MimeTypes.APPLICATION_ID3, (String) null, -1, (DrmInitData) null));
            return;
        }
    ...
    private boolean isAdtsSyncBytes(byte firstByte, byte secondByte) {
        return isAdtsSyncWord(((firstByte & UByte.MAX_VALUE) << 8) | (secondByte & 255));
    }
    ...
    private void parseAdtsHeader() throws ParserException {
        ...
        if (!this.hasOutputFormat) {
            ...
            Format format = Format.createAudioSampleFormat(this.formatId, MimeTypes.AUDIO_AAC, (String) null, -1, -1, ((Integer) audioParams.second).intValue(), ((Integer) audioParams.first).intValue(), Collections.singletonList(audioSpecificConfig), (DrmInitData) null, 0, this.language);
