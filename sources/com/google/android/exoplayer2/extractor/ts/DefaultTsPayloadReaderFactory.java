...
public final class DefaultTsPayloadReaderFactory implements TsPayloadReader.Factory {
    ...
    public DefaultTsPayloadReaderFactory(int flags2) {
        this(flags2, Collections.singletonList(Format.createTextSampleFormat((String) null, MimeTypes.APPLICATION_CEA608, 0, (String) null)));
    }
        ...
        while (scratchDescriptorData.bytesLeft() > 0) {
            ...
            if (descriptorTag == 134) {
                ...
                for (int i = 0; i < numberOfServices; i++) {
                    ...
                    closedCaptionFormats2.add(Format.createTextSampleFormat((String) null, mimeType, (String) null, -1, 0, language, accessibilityChannel, (DrmInitData) null, Long.MAX_VALUE, initializationData));
                }
            }
