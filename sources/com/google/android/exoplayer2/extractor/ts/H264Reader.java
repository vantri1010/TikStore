...
public final class H264Reader implements ElementaryStreamReader {
    ...
    public void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator idGenerator) {
        ...
        TrackOutput track = extractorOutput.track(idGenerator.getTrackId(), 2);
        this.output = track;
        ...
        if (!this.hasOutputFormat || this.sampleReader.needsSpsPps()) {
            ...
            if (!this.hasOutputFormat) {
                if (this.sps.isCompleted() && this.pps.isCompleted()) {
                    ...
                    trackOutput3.format(Format.createVideoSampleFormat(str, "video/avc", buildAvcCodecString, -1, -1, i2, i3, -1.0f, arrayList, -1, f, (DrmInitData) null));
    ...
    private static final class SampleReader {
        ...
        public void appendToNalUnit(byte[] data, int offset, int limit) {
            ...
            if (this.isFilling) {
                ...
                int i3 = this.bufferLength + readLength;
                this.bufferLength = i3;
                this.bitArray.reset(this.buffer, 0, i3);
                        ...
                        if (this.bitArray.canReadExpGolombCodedNum()) {
                            ...
                            if (!this.detectAccessUnits) {
                                ...
                                if (this.bitArray.canReadBits(spsData.frameNumLength)) {
                                        ...
                                        if (this.bitArray.canReadBits(spsData.picOrderCntLsbLength)) {
                                            ...
                                            if (ppsData.bottomFieldPicOrderInFramePresentFlag && !fieldPicFlag) {
                                                if (this.bitArray.canReadExpGolombCodedNum()) {
                                                    ...
                                                    NalUnitUtil.PpsData ppsData2 = ppsData;
                                                    int i4 = picParameterSetId;
                                        ...
                                        if (this.bitArray.canReadExpGolombCodedNum()) {
                                            ...
                                            if (ppsData.bottomFieldPicOrderInFramePresentFlag && !fieldPicFlag) {
                                                if (this.bitArray.canReadExpGolombCodedNum()) {
                                                    ...
                                                    NalUnitUtil.SpsData spsData22 = spsData;
                                                    NalUnitUtil.PpsData ppsData22 = ppsData;
                                                    int i42 = picParameterSetId;
                                                    this.sliceHeader.setAll(spsData, nalRefIdc, sliceType, frameNum, picParameterSetId, fieldPicFlag, bottomFieldFlagPresent, bottomFieldFlag, idrPicFlag, idrPicId, picOrderCntLsb, deltaPicOrderCntBottom, deltaPicOrderCnt0, deltaPicOrderCnt1);
                                                    this.isFilling = false;
                                                }
                                                return;
                                    ...
                                    deltaPicOrderCnt0 = deltaPicOrderCnt02;
                                    deltaPicOrderCnt1 = 0;
                                    NalUnitUtil.SpsData spsData222 = spsData;
                                    NalUnitUtil.PpsData ppsData222 = ppsData;
                                    int i422 = picParameterSetId;
                                    this.sliceHeader.setAll(spsData, nalRefIdc, sliceType, frameNum, picParameterSetId, fieldPicFlag, bottomFieldFlagPresent, bottomFieldFlag, idrPicFlag, idrPicId, picOrderCntLsb, deltaPicOrderCntBottom, deltaPicOrderCnt0, deltaPicOrderCnt1);
                                    this.isFilling = false;
                                }
                            }
        ...
        private void outputSample(int offset) {
            ...
            this.output.sampleMetadata(this.sampleTimeUs, flags2, (int) (this.nalUnitStartPosition - this.samplePosition), offset, (TrackOutput.CryptoData) null);
        }
