    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException, InterruptedException {
        ...
        if (this.tracksEnded) {
            ...
            if (tsBinarySearchSeeker2 != null && tsBinarySearchSeeker2.isSeeking()) {
                return this.tsBinarySearchSeeker.handlePendingSeek(extractorInput, positionHolder, (BinarySearchSeeker.OutputFrameHolder) null);
            }
        }
        ...
        if (adaptationFieldExists) {
            ...
            packetHeaderFlags |= (this.tsPacketBuffer.readUnsignedByte() & 64) != 0 ? 2 : 0;
        ...
        public void consume(ParsableByteArray sectionData) {
            ...
            if (sectionData.readUnsignedByte() == 2) {
                ...
                if (TsExtractor.this.mode == 2 && TsExtractor.this.id3Reader == null) {
                    TsPayloadReader.EsInfo dummyEsInfo = new TsPayloadReader.EsInfo(21, (String) null, (List<TsPayloadReader.DvbSubtitleInfo>) null, Util.EMPTY_BYTE_ARRAY);
