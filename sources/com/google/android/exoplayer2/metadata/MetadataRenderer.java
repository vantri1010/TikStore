...
public final class MetadataRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public MetadataRenderer(MetadataOutput output2, Looper outputLooper) {
        this(output2, outputLooper, MetadataDecoderFactory.DEFAULT);
    }

    public MetadataRenderer(MetadataOutput output2, Looper outputLooper, MetadataDecoderFactory decoderFactory2) {
        super(4);
        Handler handler;
