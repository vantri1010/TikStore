...
public class DefaultDownloaderFactory implements DownloaderFactory {
    ...
    private Downloader createDownloader(DownloadAction action, Constructor<? extends Downloader> constructor) {
        if (constructor != null) {
            try {
                return (Downloader) constructor.newInstance(new Object[]{action.uri, action.getKeys(), this.downloaderConstructorHelper});
            } catch (Exception e) {
    ...
    private static Constructor<? extends Downloader> getDownloaderConstructor(Class<?> clazz) {
        try {
            return clazz.asSubclass(Downloader.class).getConstructor(new Class[]{Uri.class, List.class, DownloaderConstructorHelper.class});
