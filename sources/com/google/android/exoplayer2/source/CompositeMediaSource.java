...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public final void prepareChildSource(T id, MediaSource mediaSource) {
        ...
        MediaSource.SourceInfoRefreshListener sourceListener = new MediaSource.SourceInfoRefreshListener(id) {
    ...
    /* access modifiers changed from: protected */
    public long getMediaTimeForChildMediaTime(T t, long mediaTimeMs) {
        return mediaTimeMs;
    }
