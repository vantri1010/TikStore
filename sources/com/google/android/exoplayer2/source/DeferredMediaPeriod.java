...
public final class DeferredMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public DeferredMediaPeriod(MediaSource mediaSource2, MediaSource.MediaPeriodId id2, Allocator allocator2, long preparePositionUs2) {
        this.id = id2;
    ...
    public void createPeriod(MediaSource.MediaPeriodId id2) {
        long preparePositionUs2 = getPreparePositionWithOverride(this.preparePositionUs);
        MediaPeriod createPeriod = this.mediaSource.createPeriod(id2, this.allocator, preparePositionUs2);
        this.mediaPeriod = createPeriod;
        if (this.callback != null) {
            createPeriod.prepare(this, preparePositionUs2);
        }
    }
    ...
    private long getPreparePositionWithOverride(long preparePositionUs2) {
        ...
        return j != C.TIME_UNSET ? j : preparePositionUs2;
    }
}
