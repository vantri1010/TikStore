...
final class ExtractorMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public ExtractorMediaPeriod(Uri uri2, DataSource dataSource2, Extractor[] extractors, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, MediaSourceEventListener.EventDispatcher eventDispatcher2, Listener listener2, Allocator allocator2, String customCacheKey2, int continueLoadingCheckIntervalBytes2) {
        this.uri = uri2;
    ...
    public void onLoadCompleted(ExtractingLoadable loadable, long elapsedRealtimeMs, long loadDurationMs) {
        if (this.durationUs == C.TIME_UNSET) {
            ...
            long j = largestQueuedTimestampUs == Long.MIN_VALUE ? 0 : 10000 + largestQueuedTimestampUs;
            this.durationUs = j;
            this.listener.onSourceInfoRefreshed(j, seekMap2.isSeekable());
        }
    ...
    private void startLoading() {
        ...
        this.eventDispatcher.loadStarted(loadable.dataSpec, 1, -1, (Format) null, 0, (Object) null, loadable.seekTimeUs, this.durationUs, this.loader.startLoading(loadable, this, this.loadErrorHandlingPolicy.getMinimumLoadableRetryCount(this.dataType)));
    }
    ...
    final class ExtractingLoadable implements Loader.Loadable, IcyDataSource.Listener {
        ...
        public void load() throws IOException, InterruptedException {
            ...
            while (result == 0 && !this.loadCanceled) {
                ...
                try {
                    ...
                    IcyHeaders unused = ExtractorMediaPeriod.this.icyHeaders = IcyHeaders.parse(this.dataSource.getResponseHeaders());
                    ...
                    if (ExtractorMediaPeriod.this.icyHeaders == null || ExtractorMediaPeriod.this.icyHeaders.metadataInterval == -1) {
                        ...
                        TrackOutput icyTrack = ExtractorMediaPeriod.this.icyTrack();
                        this.icyTrackOutput = icyTrack;
                        icyTrack.format(ExtractorMediaPeriod.ICY_FORMAT);
        ...
        public void onIcyMetadata(ParsableByteArray metadata) {
            ...
            if (!this.seenIcyMetadata) {
                timeUs = this.seekTimeUs;
            } else {
                timeUs = Math.max(ExtractorMediaPeriod.this.getLargestQueuedTimestampUs(), this.seekTimeUs);
            }
            ...
            icyTrackOutput2.sampleMetadata(timeUs, 1, length2, 0, (TrackOutput.CryptoData) null);
            this.seenIcyMetadata = true;
        }

        private DataSpec buildDataSpec(long position) {
            return new DataSpec(this.uri, position, -1, ExtractorMediaPeriod.this.customCacheKey, 22);
        }
    ...
    private static final class TrackId {
        ...
        public TrackId(int id2, boolean isIcyTrack2) {
            this.id = id2;
