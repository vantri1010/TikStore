...
public class SampleQueue implements TrackOutput {
    ...
    public void discardUpstreamSamples(int discardFromIndex) {
        long discardUpstreamSamples = this.metadataQueue.discardUpstreamSamples(discardFromIndex);
    ...
    private void readEncryptionData(DecoderInputBuffer buffer, SampleMetadataQueue.SampleExtrasHolder extrasHolder2) {
        ...
        if ((signalByte & ByteCompanionObject.MIN_VALUE) == 0) {
        ...
        int subsampleCount2 = i2;
        int i3 = subsampleCount;
        cryptoInfo.set(subsampleCount, clearDataSizes, encryptedDataSizes, bArr, bArr2, subsampleCount2, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
