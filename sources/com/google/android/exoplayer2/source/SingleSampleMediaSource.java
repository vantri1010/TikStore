...
public final class SingleSampleMediaSource extends BaseMediaSource {
    ...
    public SingleSampleMediaSource(Uri uri, DataSource.Factory dataSourceFactory2, Format format2, long durationUs2, int minLoadableRetryCount) {
        this(uri, dataSourceFactory2, format2, durationUs2, new DefaultLoadErrorHandlingPolicy(minLoadableRetryCount), false, (Object) null);
    }
    ...
    public SingleSampleMediaSource(Uri uri, DataSource.Factory dataSourceFactory2, Format format2, long durationUs2, int minLoadableRetryCount, Handler eventHandler, EventListener eventListener, int eventSourceId, boolean treatLoadErrorsAsEndOfStream2) {
        this(uri, dataSourceFactory2, format2, durationUs2, new DefaultLoadErrorHandlingPolicy(minLoadableRetryCount), treatLoadErrorsAsEndOfStream2, (Object) null);
    ...
    private SingleSampleMediaSource(Uri uri, DataSource.Factory dataSourceFactory2, Format format2, long durationUs2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, boolean treatLoadErrorsAsEndOfStream2, Object tag2) {
