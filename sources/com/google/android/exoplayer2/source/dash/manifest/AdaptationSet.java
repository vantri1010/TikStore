...
public class AdaptationSet {
    ...
    public AdaptationSet(int id2, int type2, List<Representation> representations2, List<Descriptor> accessibilityDescriptors2, List<Descriptor> supplementalProperties2) {
