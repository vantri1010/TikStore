...
public class DashManifest implements FilterableManifest<DashManifest> {
    ...
    public DashManifest(long availabilityStartTimeMs2, long durationMs2, long minBufferTimeMs2, boolean dynamic2, long minUpdatePeriodMs2, long timeShiftBufferDepthMs2, long suggestedPresentationDelayMs2, long publishTimeMs2, UtcTimingElement utcTiming2, Uri location2, List<Period> periods2) {
        this(availabilityStartTimeMs2, durationMs2, minBufferTimeMs2, dynamic2, minUpdatePeriodMs2, timeShiftBufferDepthMs2, suggestedPresentationDelayMs2, publishTimeMs2, (ProgramInformation) null, utcTiming2, location2, periods2);
    }

    public DashManifest(long availabilityStartTimeMs2, long durationMs2, long minBufferTimeMs2, boolean dynamic2, long minUpdatePeriodMs2, long timeShiftBufferDepthMs2, long suggestedPresentationDelayMs2, long publishTimeMs2, ProgramInformation programInformation2, UtcTimingElement utcTiming2, Uri location2, List<Period> periods2) {
    ...
    public final long getPeriodDurationMs(int index) {
        ...
        return j - this.periods.get(index).startMs;
    }
    ...
    public final DashManifest copy(List<StreamKey> streamKeys) {
        ...
        LinkedList<StreamKey> linkedList = keys;
    ...
    private static ArrayList<AdaptationSet> copyAdaptationSets(List<AdaptationSet> adaptationSets, LinkedList<StreamKey> keys) {
        ...
        do {
            ...
            do {
                ...
                key = keys.poll();
                if (!(key.periodIndex == periodIndex && key.groupIndex == adaptationSetIndex)) {
