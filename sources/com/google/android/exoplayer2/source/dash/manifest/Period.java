...
public class Period {
    ...
    public Period(String id2, long startMs2, List<AdaptationSet> adaptationSets2) {
        this(id2, startMs2, adaptationSets2, Collections.emptyList());
    }

    public Period(String id2, long startMs2, List<AdaptationSet> adaptationSets2, List<EventStream> eventStreams2) {
        this.id = id2;
