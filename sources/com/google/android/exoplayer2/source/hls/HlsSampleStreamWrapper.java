...
final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>, Loader.ReleaseCallback, SequenceableLoader, ExtractorOutput, SampleQueue.UpstreamFormatChangedListener {
    ...
    public HlsSampleStreamWrapper(int trackType2, Callback callback2, HlsChunkSource chunkSource2, Allocator allocator2, long positionUs, Format muxedAudioFormat2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, MediaSourceEventListener.EventDispatcher eventDispatcher2) {
    ...
    public boolean continueLoading(long positionUs) {
        ...
        if (endOfStream) {
            ...
            List<HlsMediaChunk> list = chunkQueue;
    ...
    public TrackOutput track(int id, int type) {
        ...
        copyOf2[trackCount] = type == 1 || type == 2;
    ...
    private void buildTracksFromSampleStreams() {
        ...
        while (true) {
            ...
            if (i3 == primaryExtractorTrackIndex) {
                ...
                trackGroups2[i3] = new TrackGroup(deriveFormat((primaryExtractorTrackType != 2 || !MimeTypes.isAudio(sampleFormat.sampleMimeType)) ? null : this.muxedAudioFormat, sampleFormat, false));
            }
            i3++;
        }
