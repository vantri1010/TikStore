...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public static final class Segment implements Comparable<Long> {
        ...
        public Segment(String uri, long byterangeOffset2, long byterangeLength2) {
            this(uri, (Segment) null, "", 0, -1, C.TIME_UNSET, (DrmInitData) null, (String) null, (String) null, byterangeOffset2, byterangeLength2, false);
        }

        public Segment(String url2, Segment initializationSegment2, String title2, long durationUs2, int relativeDiscontinuitySequence2, long relativeStartTimeUs2, DrmInitData drmInitData2, String fullSegmentEncryptionKeyUri2, String encryptionIV2, long byterangeOffset2, long byterangeLength2, boolean hasGapTag2) {
            this.url = url2;
        ...
        public int compareTo(Long relativeStartTimeUs2) {
    ...
    public HlsMediaPlaylist(int playlistType2, String baseUri, List<String> tags, long startOffsetUs2, long startTimeUs2, boolean hasDiscontinuitySequence2, int discontinuitySequence2, long mediaSequence2, int version2, long targetDurationUs2, boolean hasIndependentSegments, boolean hasEndTag2, boolean hasProgramDateTime2, DrmInitData protectionSchemes2, List<Segment> segments2) {
        ...
        this.startOffsetUs = startOffsetUs2 != C.TIME_UNSET ? startOffsetUs2 >= j ? startOffsetUs2 : this.durationUs + startOffsetUs2 : C.TIME_UNSET;
    }
