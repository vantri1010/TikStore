...
public class DefaultSsChunkSource implements SsChunkSource {
    ...
    public DefaultSsChunkSource(LoaderErrorThrower manifestLoaderErrorThrower2, SsManifest manifest2, int streamElementIndex2, TrackSelection trackSelection2, DataSource dataSource2) {
        ...
        while (i2 < this.extractorWrappers.length) {
            ...
            this.extractorWrappers[i2] = new ChunkExtractorWrapper(new FragmentedMp4Extractor(3, (TimestampAdjuster) null, new Track(manifestTrackIndex, streamElement.type, streamElement.timescale, C.TIME_UNSET, ssManifest.durationUs, format2, 0, format.drmInitData != null ? ssManifest.protectionElement.trackEncryptionBoxes : null, streamElement.type == 2 ? 4 : 0, (long[]) null, (long[]) null), (DrmInitData) null), streamElement.type, format2);
            i2++;
    ...
    public long getAdjustedSeekPositionUs(long positionUs, SeekParameters seekParameters) {
        ...
        return Util.resolveSeekPositionUs(positionUs, seekParameters, firstSyncUs, (firstSyncUs >= positionUs || chunkIndex >= streamElement.chunkCount + -1) ? firstSyncUs : streamElement.getStartTimeUs(chunkIndex + 1));
    }
    ...
    public final void getNextChunk(long playbackPositionUs, long loadPositionUs, List<? extends MediaChunk> queue, ChunkHolder out) {
        ...
        if (this.fatalError == null) {
            ...
            MediaChunkIterator[] mediaChunkIteratorArr = chunkIterators;
            ...
            chunkHolder.chunk = newMediaChunk(this.trackSelection.getSelectedFormat(), this.dataSource, streamElement.buildRequestUri(this.trackSelection.getIndexInTrackGroup(trackSelectionIndex), chunkIndex), (String) null, this.currentManifestChunkOffset + chunkIndex, chunkStartTimeUs, chunkEndTimeUs, chunkSeekTimeUs, this.trackSelection.getSelectionReason(), this.trackSelection.getSelectionData(), extractorWrapper);
        }
    }
    ...
    private static MediaChunk newMediaChunk(Format format, DataSource dataSource2, Uri uri, String cacheKey, int chunkIndex, long chunkStartTimeUs, long chunkEndTimeUs, long chunkSeekTimeUs, int trackSelectionReason, Object trackSelectionData, ChunkExtractorWrapper extractorWrapper) {
        ...
        return new ContainerMediaChunk(dataSource2, new DataSpec(uri, 0, -1, cacheKey), format, i, obj, chunkStartTimeUs, chunkEndTimeUs, chunkSeekTimeUs, C.TIME_UNSET, (long) chunkIndex, 1, chunkStartTimeUs, extractorWrapper);
    }
