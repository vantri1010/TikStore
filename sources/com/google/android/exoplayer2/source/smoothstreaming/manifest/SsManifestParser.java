...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    public SsManifest parse(Uri uri, InputStream inputStream) throws IOException {
        try {
            ...
            return (SsManifest) new SmoothStreamingMediaParser((ElementParser) null, uri.toString()).parse(xmlParser);
        } catch (XmlPullParserException e) {
    ...
    private static class ProtectionParser extends ElementParser {
        ...
        private static TrackEncryptionBox[] buildTrackEncryptionBoxes(byte[] initData2) {
            return new TrackEncryptionBox[]{new TrackEncryptionBox(true, (String) null, 8, getProtectionElementKeyId(initData2), 0, 0, (byte[]) null)};
        }
    ...
    private static class StreamIndexParser extends ElementParser {
        ...
        private void parseStreamElementStartTag(XmlPullParser parser) throws ParserException {
            ...
            String attributeValue = parser.getAttributeValue((String) null, KEY_LANGUAGE);
            this.language = attributeValue;
            putNormalizedAttribute(KEY_LANGUAGE, attributeValue);
            long parseInt = (long) parseInt(parser, KEY_TIME_SCALE, -1);
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser parser) throws ParserException {
            ...
            String id = xmlPullParser.getAttributeValue((String) null, KEY_INDEX);
            ...
            if (type == 2) {
                this.format = Format.createVideoContainerFormat(id, name, MimeTypes.VIDEO_MP4, sampleMimeType, (String) null, bitrate, parseRequiredInt(xmlPullParser, KEY_MAX_WIDTH), parseRequiredInt(xmlPullParser, KEY_MAX_HEIGHT), -1.0f, buildCodecSpecificData(xmlPullParser.getAttributeValue((String) null, KEY_CODEC_PRIVATE_DATA)), 0);
            } else if (type == 1) {
                ...
                List<byte[]> codecSpecificData = buildCodecSpecificData(xmlPullParser.getAttributeValue((String) null, KEY_CODEC_PRIVATE_DATA));
                ...
                int i = samplingRate;
                int i2 = channels;
                this.format = Format.createAudioContainerFormat(id, name, MimeTypes.AUDIO_MP4, sampleMimeType2, (String) null, bitrate, channels, samplingRate, codecSpecificData, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
                String language = sampleMimeType2;
            } else if (type == 3) {
                this.format = Format.createTextContainerFormat(id, name, MimeTypes.APPLICATION_MP4, sampleMimeType, (String) null, bitrate, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
            } else {
                this.format = Format.createContainerFormat(id, name, MimeTypes.APPLICATION_MP4, sampleMimeType, (String) null, bitrate, 0, (String) null);
            }
        }
