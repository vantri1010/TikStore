...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public TextRenderer(TextOutput output2, Looper outputLooper) {
        this(output2, outputLooper, SubtitleDecoderFactory.DEFAULT);
    }

    public TextRenderer(TextOutput output2, Looper outputLooper, SubtitleDecoderFactory decoderFactory2) {
        super(3);
        Handler handler;
