...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private static final class CueBuilder {
        ...
        public void setPenColor(int foregroundColor2, int backgroundColor2, int edgeColor) {
            if (!(this.foregroundColorStartPosition == -1 || this.foregroundColor == foregroundColor2)) {
            ...
            if (!(this.backgroundColorStartPosition == -1 || this.backgroundColor == backgroundColor2)) {
