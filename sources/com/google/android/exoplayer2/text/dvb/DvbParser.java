...
final class DvbParser {
    ...
    private static RegionComposition parseRegionComposition(ParsableBitArray data, int length) {
        ...
        SparseArray<RegionObject> sparseArray = regionObjects;
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray data, int length) {
        ...
        while (remainingLength2 > 0) {
            ...
            if ((entryFlags & 1) != 0) {
                ...
                y = parsableBitArray.readBits(4) << 4;
            }
            if (t == 0) {
                y = 0;
                cb2 = 0;
            ...
            clutEntries[entryId] = getColor((byte) (255 - (cb & 255)), Util.constrainValue((int) (((double) t) + (((double) (y - 128)) * 1.402d)), 0, 255), Util.constrainValue((int) ((((double) t) - (((double) (cb2 - 128)) * 0.34414d)) - (((double) (y - 128)) * 0.71414d)), 0, 255), Util.constrainValue((int) (((double) t) + (((double) (cb2 - 128)) * 1.772d)), 0, 255));
            ...
            if (dataType != 240) {
                switch (dataType) {
                    case 16:
                        ...
                        int column2 = paint2BitPixelCodeString(data, clutEntries, clutMapTable2ToX, column, line, paint, canvas2);
                        data.byteAlign();
                        column = column2;
                        break;
                    case 17:
                        ...
                        int column3 = paint4BitPixelCodeString(data, clutEntries, clutMapTable4ToX, column, line, paint, canvas2);
                        data.byteAlign();
                        column = column3;
                        break;
                    case 18:
