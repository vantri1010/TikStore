        ...
        public void parsePaletteSection(ParsableByteArray buffer, int sectionLength) {
            if (sectionLength % 5 == 2) {
                ...
                for (int entryCount = sectionLength / 5; i < entryCount; entryCount = entryCount) {
                    ...
                    this.colors[index] = (buffer.readUnsignedByte() << 24) | (Util.constrainValue((int) (((double) y) + (((double) (cr - 128)) * 1.402d)), 0, 255) << 16) | (Util.constrainValue((int) ((((double) y) - (((double) (cb - 128)) * 0.34414d)) - (((double) (cr - 128)) * 0.71414d)), 0, 255) << 8) | Util.constrainValue((int) (((double) y) + (((double) (cb - 128)) * 1.772d)), 0, 255);
                    i++;
