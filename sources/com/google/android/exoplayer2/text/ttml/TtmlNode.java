...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String text2) {
        return new TtmlNode((String) null, TtmlRenderUtil.applyTextElementSpacePolicy(text2), C.TIME_UNSET, C.TIME_UNSET, (TtmlStyle) null, (String[]) null, "", (String) null);
    }

    public static TtmlNode buildNode(String tag2, long startTimeUs2, long endTimeUs2, TtmlStyle style2, String[] styleIds2, String regionId2, String imageId2) {
        return new TtmlNode(tag2, (String) null, startTimeUs2, endTimeUs2, style2, styleIds2, regionId2, imageId2);
    }

    private TtmlNode(String tag2, String text2, long startTimeUs2, long endTimeUs2, TtmlStyle style2, String[] styleIds2, String regionId2, String imageId2) {
        this.tag = tag2;
        this.text = text2;
    ...
    public List<Cue> getCues(long timeUs, Map<String, TtmlStyle> globalStyles, Map<String, TtmlRegion> regionMap, Map<String, String> imageMap) {
        ...
        while (it.hasNext()) {
            ...
            if (encodedBitmapData != null) {
                ...
                Pair<String, String> pair = regionImagePair;
                String str = encodedBitmapData;
                Cue cue = r15;
        ...
        for (Map.Entry<String, SpannableStringBuilder> entry : regionTextOutputs.entrySet()) {
            ...
            cues.add(new Cue((CharSequence) cleanUpText(entry.getValue()), (Layout.Alignment) null, region2.line, region2.lineType, region2.lineAnchor, region2.position, Integer.MIN_VALUE, region2.width, region2.textSizeType, region2.textSize));
        }
        return cues;
    }
