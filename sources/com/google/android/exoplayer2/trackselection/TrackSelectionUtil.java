...
public final class TrackSelectionUtil {
    ...
    static int[] getBitratesUsingFutureInfo(MediaChunkIterator[] iterators, Format[] formats, long maxDurationUs, int[] bitrates) {
    ...
    static int[] getBitratesUsingPastInfo(List<? extends MediaChunk> queue, Format[] formats, long maxDurationUs, int[] bitrates) {
    ...
    public static int[] getBitratesUsingPastAndFutureInfo(Format[] formats, List<? extends MediaChunk> queue, long maxPastDurationUs, MediaChunkIterator[] iterators, long maxFutureDurationUs, boolean useFormatBitrateAsLowerBound, int[] bitrates) {
    ...
    public static int[] getFormatBitrates(Format[] formats, int[] bitrates) {
