...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    private DefaultBandwidthMeter(Context context2, SparseArray<Long> initialBitrateEstimates2, int maxWeight, Clock clock2, boolean resetOnNetworkTypeChange) {
        this.context = context2 == null ? null : context2.getApplicationContext();
        this.initialBitrateEstimates = initialBitrateEstimates2;
        this.eventDispatcher = new EventDispatcher<>();
        this.slidingPercentile = new SlidingPercentile(maxWeight);
        this.clock = clock2;
        int networkType2 = context2 == null ? 0 : Util.getNetworkType(context2);
    ...
    private void maybeNotifyBandwidthSample(int elapsedMs, long bytesTransferred, long bitrateEstimate2) {
        if (elapsedMs != 0 || bytesTransferred != 0 || bitrateEstimate2 != this.lastReportedBitrateEstimate) {
            ...
            this.eventDispatcher.dispatch(new EventDispatcher.Event(elapsedMs, bytesTransferred, bitrateEstimate2) {
    ...
    private static class ConnectivityActionReceiver extends BroadcastReceiver {
        ...
        public synchronized void register(DefaultBandwidthMeter bandwidthMeter) {
            ...
            this.mainHandler.post(new Runnable(bandwidthMeter) {
            ...
            if (!isInitialStickyBroadcast()) {
                ...
                for (int i = 0; i < this.bandwidthMeters.size(); i++) {
                    ...
                    if (bandwidthMeter != null) {
                        lambda$register$0$DefaultBandwidthMeter$ConnectivityActionReceiver(bandwidthMeter);
                    }
                }
            }
        }
    ...
    private static Map<String, int[]> createInitialBitrateCountryGroupAssignment() {
        ...
        countryGroupAssignment.put(ExpandedProductParsedResult.KILOGRAM, new int[]{2, 2, 3, 3});
        ...
        countryGroupAssignment.put(ExpandedProductParsedResult.POUND, new int[]{3, 2, 0, 0});
