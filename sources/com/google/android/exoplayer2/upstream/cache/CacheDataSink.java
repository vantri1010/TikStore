...
public final class CacheDataSink implements DataSink {
    ...
    public CacheDataSink(Cache cache2, long fragmentSize2, int bufferSize2) {
        ...
        if (fragmentSize2 != -1 && fragmentSize2 < MIN_RECOMMENDED_FRAGMENT_SIZE) {
    ...
    public void experimental_setRespectCacheFragmentationFlag(boolean respectCacheFragmentationFlag2) {
        this.respectCacheFragmentationFlag = respectCacheFragmentationFlag2;
    }

    public void open(DataSpec dataSpec2) throws CacheDataSinkException {
        if (dataSpec2.length != -1 || !dataSpec2.isFlagSet(4)) {
            this.dataSpec = dataSpec2;
            this.dataSpecFragmentSize = (!this.respectCacheFragmentationFlag || dataSpec2.isFlagSet(16)) ? this.fragmentSize : Long.MAX_VALUE;
