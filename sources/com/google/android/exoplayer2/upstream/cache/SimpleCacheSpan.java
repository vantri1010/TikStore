...
final class SimpleCacheSpan extends CacheSpan {
    ...
    public static SimpleCacheSpan createLookup(String key, long position) {
        return new SimpleCacheSpan(key, position, -1, C.TIME_UNSET, (File) null);
    }
    ...
    public static SimpleCacheSpan createClosedHole(String key, long position, long length) {
        return new SimpleCacheSpan(key, position, length, C.TIME_UNSET, (File) null);
    }
    ...
    public static SimpleCacheSpan createCacheEntry(File file, long length, CachedContentIndex index) {
        ...
        return new SimpleCacheSpan(key, Long.parseLong(matcher.group(2)), length, Long.parseLong(matcher.group(3)), file2);
    }
