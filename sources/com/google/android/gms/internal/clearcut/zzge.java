...
public final class zzge {
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            SOCIAL_AFFINITY_INBOX(UIMsg.m_AppUI.MSG_CHINA_SUP_ITS),
            ...
            SHEETS_ANDROID_PRIMES(BDLocation.TypeServerError),
            ...
            INSTORE_CONSUMER_PRIMES(MessageObject.TYPE_LIVE),
            ...
            PYROCLASM(153),
            ANDROID_GSA_COUNTERS(BDLocation.TypeNetWorkLocation),
            JAM_IMPRESSIONS(BDLocation.TypeServerDecryptError),
            ...
            VR_SDK_ANDROID_PRIMES(UIMsg.l_ErrorNo.NETWORK_ERROR_404),
            PHOTOS_SCANNER(406),
            BG_IN_OGB(407),
            BLOGGER(408),
            CORP_IOS_FOOD(409),
            ...
            TESTDRIVE_PRIMES(CodeUtils.DEFAULT_REQ_WIDTH),
            ...
            PIGEON_EXPERIMENTAL(UVCCamera.DEFAULT_PREVIEW_HEIGHT),
            ...
            NETREC(UIMsg.d_ResultType.VERSION_CHECK),
            NETREC_COUNTERS(UIMsg.d_ResultType.NEWVERSION_DOWNLOAD),
            DASHER_ADMINCONSOLE(UIMsg.d_ResultType.CELLID_LOCATE_REQ),
            SESAME_CAMERA_LAUNCH(UIMsg.d_ResultType.LOC_INFO_UPLOAD),
            GOOGLE_RED_ANDROID_PRIMES(505),
            SEARCHLITE(UIMsg.d_ResultType.SUGGESTION_SEARCH),
            CONTACTS_ASSISTANTS(UIMsg.d_ResultType.LONG_URL),
            CONCORD(509),
            ...
            TOPAZ_IOS_PRIMES(UIMsg.m_AppUI.MSG_CITY_SUP_DOM),
            NEWS_EVENT(UIMsg.m_AppUI.MSG_COMPASS_DISPLAY),
            CHROMOTING(UIMsg.m_AppUI.MSG_SET_SENSOR_STATUS),
            CHROMOTING_COUNTERS(UIMsg.m_AppUI.MSG_PLACEFIELD_RELOAD),
            ...
            TURBO(599),
            ANDROID_OTA(BannerConfig.SCROLL_TIME),
            SENSE_AMBIENTMUSIC(LBSAuthManager.CODE_UNAUTHENTICATE),
            SENSE_DND(LBSAuthManager.CODE_AUTHENTICATING),
            LIBASSISTANT(603),
            STREAMZ(604),
            EUICC(605),
            MEDICAL_SCRIBE(606),
            ...
            GMSCORE_BACKEND_COUNTERS(UVCCamera.DEFAULT_PREVIEW_WIDTH),
            ...
            ARCORE(HardwareConfigState.DEFAULT_MAXIMUM_FDS_FOR_HARDWARE_CONFIGS),
            ...
            BETTERBUG_ANDROID(CodeUtils.DEFAULT_REQ_HEIGHT),
            ...
            static {
                /*
                    ...
                    com.google.android.gms.internal.clearcut.zzge$zzq$zzb r11 = zzzs
                    r15 = 0
                    r8[r15] = r11
                    ...
                    r8[r9] = r7
                    com.google.android.gms.internal.clearcut.zzge$zzq$zzb r7 = zzakv
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case 206:
                        return APP_CATALOG;
                    case MessageObject.TYPE_LIVE /*207*/:
                    ...
                    case CodeUtils.DEFAULT_REQ_WIDTH:
                    ...
                    case UVCCamera.DEFAULT_PREVIEW_HEIGHT:
                    ...
                    case UIMsg.m_AppUI.MSG_CHINA_SUP_ITS:
                        return SOCIAL_AFFINITY_INBOX;
                    case UIMsg.m_AppUI.MSG_CITY_SUP_DOM:
                        return TOPAZ_IOS_PRIMES;
                    case UIMsg.m_AppUI.MSG_COMPASS_DISPLAY:
                        return NEWS_EVENT;
                    case UIMsg.m_AppUI.MSG_SET_SENSOR_STATUS:
                        return CHROMOTING;
                    case UIMsg.m_AppUI.MSG_PLACEFIELD_RELOAD:
                    ...
                    case BannerConfig.SCROLL_TIME /*600*/:
                        return ANDROID_OTA;
                    case LBSAuthManager.CODE_UNAUTHENTICATE:
                        return SENSE_AMBIENTMUSIC;
                    case LBSAuthManager.CODE_AUTHENTICATING:
                        return SENSE_DND;
                    case 603:
                        return LIBASSISTANT;
                    case 604:
                    ...
                    case UVCCamera.DEFAULT_PREVIEW_WIDTH:
                    ...
                    case HardwareConfigState.DEFAULT_MAXIMUM_FDS_FOR_HARDWARE_CONFIGS:
                        return ARCORE;
                    case 701:
                    ...
                    case CodeUtils.DEFAULT_REQ_HEIGHT:
