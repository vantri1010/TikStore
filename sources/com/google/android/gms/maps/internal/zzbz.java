...
public class zzbz {
    ...
    public static com.google.android.gms.maps.internal.zze zza(android.content.Context r3) throws com.google.android.gms.common.GooglePlayServicesNotAvailableException {
        ...
        L_0x0045:
            zzcl = r0
            android.content.Context r3 = zzb(r3)     // Catch:{ RemoteException -> 0x005d }
            android.content.res.Resources r3 = r3.getResources()     // Catch:{ RemoteException -> 0x005d }
            com.google.android.gms.dynamic.IObjectWrapper r3 = com.google.android.gms.dynamic.ObjectWrapper.wrap(r3)     // Catch:{ RemoteException -> 0x005d }
            int r1 = com.google.android.gms.common.GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE     // Catch:{ RemoteException -> 0x005d }
            r0.zza((com.google.android.gms.dynamic.IObjectWrapper) r3, (int) r1)     // Catch:{ RemoteException -> 0x005d }
