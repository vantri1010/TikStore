...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Notification {
        ...
        private Notification(zzn zzn2) {
            this.zza = zzn2.zza("gcm.n.title");
            this.zzb = zzn2.zze("gcm.n.title");
            this.zzc = zza(zzn2, "gcm.n.title");
            this.zzd = zzn2.zza("gcm.n.body");
            this.zze = zzn2.zze("gcm.n.body");
            this.zzf = zza(zzn2, "gcm.n.body");
            this.zzg = zzn2.zza("gcm.n.icon");
            this.zzi = zzn2.zzb();
            this.zzj = zzn2.zza("gcm.n.tag");
            this.zzk = zzn2.zza("gcm.n.color");
            this.zzl = zzn2.zza("gcm.n.click_action");
            this.zzm = zzn2.zza("gcm.n.android_channel_id");
            this.zzn = zzn2.zza();
            this.zzh = zzn2.zza("gcm.n.image");
            this.zzo = zzn2.zza("gcm.n.ticker");
            this.zzp = zzn2.zzc("gcm.n.notification_priority");
            this.zzq = zzn2.zzc("gcm.n.visibility");
            this.zzr = zzn2.zzc("gcm.n.notification_count");
            this.zzu = zzn2.zzb("gcm.n.sticky");
            this.zzv = zzn2.zzb("gcm.n.local_only");
            this.zzw = zzn2.zzb("gcm.n.default_sound");
            this.zzx = zzn2.zzb("gcm.n.default_vibrate_timings");
            this.zzy = zzn2.zzb("gcm.n.default_light_settings");
            this.zzt = zzn2.zzd("gcm.n.event_time");
            this.zzs = zzn2.zzd();
            this.zzz = zzn2.zzc();
        }

        private static String[] zza(zzn zzn2, String str) {
            Object[] zzf2 = zzn2.zzf(str);
            if (zzf2 == null) {
                return null;
            }
