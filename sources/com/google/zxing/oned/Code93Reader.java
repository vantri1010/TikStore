...
public final class Code93Reader extends OneDReader {
    ...
    static {
        int[] iArr = {276, 328, 324, 322, 296, 292, 290, 336, 274, 266, 424, 420, 418, UIMsg.l_ErrorNo.NETWORK_ERROR_404, 402, 394, 360, 356, 354, StatusLine.HTTP_PERM_REDIRECT, 282, 344, 332, 326, 300, 278, 436, 434, 428, 422, 406, 410, 364, 358, 310, 314, 302, 468, 466, 458, 366, 374, 430, 294, 474, 470, 306, 350};
            ...
            if (pattern >= 0) {
                ...
                if (decodedChar == '*') {
                    ...
                    if (nextStart == end || !bitArray.get(nextStart)) {
                        ...
                        return new Result(decodeExtended(result), (byte[]) null, new ResultPoint[]{new ResultPoint(((float) (start[i2] + start[c])) / 2.0f, (float) i), new ResultPoint(((float) lastStart) + (((float) lastPatternSize) / 2.0f), (float) i)}, BarcodeFormat.CODE_93);
                    } else {
                        throw NotFoundException.getNotFoundInstance();
                    }
                } else {
