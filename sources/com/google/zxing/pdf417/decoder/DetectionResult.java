...
final class DetectionResult {
    ...
    public java.lang.String toString() {
        ...
        L_0x0010:
            ...
            r2 = 0
        L_0x0016:
            com.google.zxing.pdf417.decoder.Codeword[] r6 = r4.getCodewords()     // Catch:{ all -> 0x0082 }
            int r6 = r6.length     // Catch:{ all -> 0x0082 }
            if (r2 >= r6) goto L_0x007a
            java.lang.String r6 = "CW %3d:"
            java.lang.Object[] r7 = new java.lang.Object[r5]     // Catch:{ all -> 0x0082 }
            java.lang.Integer r8 = java.lang.Integer.valueOf(r2)     // Catch:{ all -> 0x0082 }
            r7[r1] = r8     // Catch:{ all -> 0x0082 }
            r0.format(r6, r7)     // Catch:{ all -> 0x0082 }
            r6 = 0
        L_0x002b:
            int r7 = r10.barcodeColumnCount     // Catch:{ all -> 0x0082 }
            r8 = 2
            int r7 = r7 + r8
            if (r6 >= r7) goto L_0x0070
            com.google.zxing.pdf417.decoder.DetectionResultColumn[] r7 = r10.detectionResultColumns     // Catch:{ all -> 0x0082 }
            r7 = r7[r6]     // Catch:{ all -> 0x0082 }
            java.lang.String r9 = "    |   "
            if (r7 != 0) goto L_0x003f
            java.lang.Object[] r7 = new java.lang.Object[r1]     // Catch:{ all -> 0x0082 }
            r0.format(r9, r7)     // Catch:{ all -> 0x0082 }
            goto L_0x006d
        L_0x003f:
            com.google.zxing.pdf417.decoder.DetectionResultColumn[] r7 = r10.detectionResultColumns     // Catch:{ all -> 0x0082 }
            r7 = r7[r6]     // Catch:{ all -> 0x0082 }
            com.google.zxing.pdf417.decoder.Codeword[] r7 = r7.getCodewords()     // Catch:{ all -> 0x0082 }
            r7 = r7[r2]     // Catch:{ all -> 0x0082 }
            r3 = r7
        ...
        L_0x0052:
            ...
            int r9 = r3.getRowNumber()     // Catch:{ all -> 0x0082 }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r9)     // Catch:{ all -> 0x0082 }
            r8[r1] = r9     // Catch:{ all -> 0x0082 }
            int r9 = r3.getValue()     // Catch:{ all -> 0x0082 }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r9)     // Catch:{ all -> 0x0082 }
            r8[r5] = r9     // Catch:{ all -> 0x0082 }
            r0.format(r7, r8)     // Catch:{ all -> 0x0082 }
        L_0x006d:
            int r6 = r6 + 1
            goto L_0x002b
        L_0x0070:
            ...
            goto L_0x0016
        L_0x007a:
            java.lang.String r1 = r0.toString()     // Catch:{ all -> 0x0082 }
            r0.close()
            return r1
        L_0x0082:
            r1 = move-exception
