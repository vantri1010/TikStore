...
public class AppendTrack extends AbstractTrack {
    ...
    public AppendTrack(Track... tracks2) throws IOException {
        ...
        for (Track track : tracks2) {
            ...
            if (sampleDescriptionBox == null) {
                ...
                sampleDescriptionBox2.addBox(track.getSampleDescriptionBox().getBoxes(SampleEntry.class).get(0));
            } else {
    ...
    public synchronized long[] getSampleDurations() {
        ...
        for (Track track2 : this.tracks) {
            ...
            int i = 0;
            while (i < length) {
                decodingTimes[index] = sampleDurations[i];
                i++;
                index++;
            }
        }
    ...
    public List<CompositionTimeToSample.Entry> getCompositionTimeEntries() {
        ...
        for (int[] list : lists) {
            for (int compositionTime : r6.next()) {
