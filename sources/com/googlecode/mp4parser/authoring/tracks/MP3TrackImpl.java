...
public class MP3TrackImpl extends AbstractTrack {
    ...
    public MP3TrackImpl(DataSource dataSource2, String lang) throws IOException {
        ...
        MP3Header readSamples = readSamples(dataSource2);
        this.firstHeader = readSamples;
        double packetsPerSecond = ((double) readSamples.sampleRate) / 1152.0d;
    ...
    private MP3Header readSamples(DataSource channel) throws IOException {
        ...
        while (true) {
            ...
            MP3Header readMP3Header = readMP3Header(channel);
            MP3Header hdr = readMP3Header;
