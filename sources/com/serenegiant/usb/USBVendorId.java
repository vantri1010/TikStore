...
public class USBVendorId {
    ...
    static {
        ...
        IDS = sparseArray;
        sparseArray.put(XiaomiUtilities.OP_WRITE_MMS, "YUEN DA ELECTRONIC PRODUCTS FACTORY");
        IDS.put(XiaomiUtilities.OP_DELETE_CALL_LOG, "Gionee Communication Equipment Co., Ltd. ShenZhen");
        IDS.put(XiaomiUtilities.OP_GET_INSTALLED_APPS, "Universal Electronics Inc. (dba: TVIEW)");
        ...
        IDS.put(MessagesController.UPDATE_MASK_ALL, "LeCroy Corporation");
        ...
        IDS.put(WearableStatusCodes.DATA_ITEM_TOO_LARGE, "Chief Land Electronic Co., Ltd.");
