...
import im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame;
...
public class MP3Info extends AudioInfo {
    ...
    public im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame readFirstFrame(im.bclpbkiauv.messenger.audioinfo.mp3.MP3Input r18, im.bclpbkiauv.messenger.audioinfo.mp3.MP3Info.StopReadCondition r19) throws java.io.IOException {
        /*
            r17 = this;
            r1 = r18
            r2 = r19
        ...
        L_0x004a:
            r10 = 0
            im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame$Header r0 = new im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame$Header     // Catch:{ MP3Exception -> 0x0052 }
        ...
        L_0x0053:
            ...
            im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame r0 = new im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame
            r0.<init>(r10, r11)
            r12 = r0
        ...
        L_0x00c1:
            ...
            goto L_0x00eb
        L_0x00c9:
            im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame$Header r0 = new im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame$Header     // Catch:{ MP3Exception -> 0x00e5 }
        ...
        L_0x0115:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.messenger.audioinfo.mp3.MP3Info.readFirstFrame(im.bclpbkiauv.messenger.audioinfo.mp3.MP3Input, im.bclpbkiauv.messenger.audioinfo.mp3.MP3Info$StopReadCondition):im.bclpbkiauv.messenger.audioinfo.mp3.MP3Frame");
    }
