package im.bclpbkiauv.messenger.support;
...
public abstract class JobIntentService extends Service {
    ...
    static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0029, code lost:
            return new im.bclpbkiauv.messenger.support.JobIntentService.JobServiceEngineImpl.WrapperWorkItem(r4, r0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x002a, code lost:
            return null;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public im.bclpbkiauv.messenger.support.JobIntentService.GenericWorkItem dequeueWork() {
            /*
                r4 = this;
                r0 = 0
                java.lang.Object r1 = r4.mLock
                monitor-enter(r1)
                android.app.job.JobParameters r2 = r4.mParams     // Catch:{ all -> 0x002b }
                r3 = 0
                if (r2 != 0) goto L_0x000b
                monitor-exit(r1)     // Catch:{ all -> 0x002b }
                return r3
            L_0x000b:
                android.app.job.JobParameters r2 = r4.mParams     // Catch:{ all -> 0x0013 }
                android.app.job.JobWorkItem r2 = r2.dequeueWork()     // Catch:{ all -> 0x0013 }
                r0 = r2
                goto L_0x0014
            L_0x0013:
                r2 = move-exception
            L_0x0014:
                ...
                im.bclpbkiauv.messenger.support.JobIntentService r2 = r4.mService
                java.lang.ClassLoader r2 = r2.getClassLoader()
                r1.setExtrasClassLoader(r2)
                im.bclpbkiauv.messenger.support.JobIntentService$JobServiceEngineImpl$WrapperWorkItem r1 = new im.bclpbkiauv.messenger.support.JobIntentService$JobServiceEngineImpl$WrapperWorkItem
                r1.<init>(r0)
                return r1
            L_0x002a:
                return r3
            L_0x002b:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.messenger.support.JobIntentService.JobServiceEngineImpl.dequeueWork():im.bclpbkiauv.messenger.support.JobIntentService$GenericWorkItem");
        }
    }
