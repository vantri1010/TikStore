...
public class CustomTabsHelper {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00be, code lost:
        r0 = im.bclpbkiauv.messenger.ApplicationLoader.applicationContext.getPackageManager();
     */
    ...
    public static java.lang.String getPackageNameToUse(android.content.Context r11) {
        ...
        L_0x00b4:
            ...
            android.content.Context r7 = im.bclpbkiauv.messenger.ApplicationLoader.applicationContext     // Catch:{ all -> 0x00d6 }
        ...
        L_0x00d7:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.messenger.support.customtabsclient.shared.CustomTabsHelper.getPackageNameToUse(android.content.Context):java.lang.String");
    }
