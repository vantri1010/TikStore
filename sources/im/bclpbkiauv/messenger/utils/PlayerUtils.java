...
import im.bclpbkiauv.ui.hviews.ScaleTextureView;
...
public class PlayerUtils extends ViewGroup implements VideoPlayer.VideoPlayerDelegate, AudioManager.OnAudioFocusChangeListener {
        ...
        private void interpretExpression(String expr, HashMap<String, String> localVars, int allowRecursion) throws Exception {
            ...
            if (!TextUtils.isEmpty(expr2)) {
                ...
                while (true) {
                    ...
                    if (a < strArr.length) {
                        Matcher matcher2 = Pattern.compile(String.format(Locale.US, "(?x)(%s)(?:\\[([^\\]]+?)\\])?\\s*%s(.*)$", new Object[]{PlayerUtils.exprName, Pattern.quote(strArr[a])})).matcher(expr2);
                        if (!matcher2.find()) {
                            a++;
                        } else {
                        ...
                        try {
                            ...
                            if (!Pattern.compile(String.format(Locale.US, "(?!if|return|true|false)(%s)$", new Object[]{PlayerUtils.exprName})).matcher(expr2).find()) {
                                if (expr2.charAt(0) != '\"' || expr2.charAt(expr2.length() - 1) != '\"') {
                                    try {
                                        new JSONObject(expr2).toString();
                                        return;
                                    } catch (Exception e2) {
                                        Matcher matcher3 = Pattern.compile(String.format(Locale.US, "(%s)\\[(.+)\\]$", new Object[]{PlayerUtils.exprName})).matcher(expr2);
                                        if (matcher3.find()) {
                                            String group = matcher3.group(1);
                                            interpretExpression(matcher3.group(2), localVars, allowRecursion - 1);
                                            return;
                                        }
                                        Matcher matcher4 = Pattern.compile(String.format(Locale.US, "(%s)(?:\\.([^(]+)|\\[([^]]+)\\])\\s*(?:\\(+([^()]*)\\))?$", new Object[]{PlayerUtils.exprName})).matcher(expr2);
                                        if (matcher4.find()) {
                                            ...
                                            Matcher matcher5 = Pattern.compile(String.format(Locale.US, "(%s)\\[(.+)\\]$", new Object[]{PlayerUtils.exprName})).matcher(expr2);
                                            if (matcher5.find()) {
                                            ...
                                            while (true) {
                                                ...
                                                if (a2 < strArr2.length) {
                                                    ...
                                                    Matcher matcher7 = Pattern.compile(String.format(Locale.US, "^(%s)\\(([a-zA-Z0-9_$,]*)\\)$", new Object[]{PlayerUtils.exprName})).matcher(expr2);
                                                    if (matcher7.find()) {
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Code restructure failed: missing block: B:143:0x01ea, code lost:
        r10 = r20;
     */
    /* JADX WARNING: Removed duplicated region for block: B:101:0x0175  */
    /* JADX WARNING: Removed duplicated region for block: B:117:0x01a3 A[SYNTHETIC, Splitter:B:117:0x01a3] */
    /* JADX WARNING: Removed duplicated region for block: B:154:0x0205 A[SYNTHETIC, Splitter:B:154:0x0205] */
    /* JADX WARNING: Removed duplicated region for block: B:158:0x0211  */
    /* JADX WARNING: Removed duplicated region for block: B:160:0x0217  */
    /* JADX WARNING: Removed duplicated region for block: B:161:0x021c A[ORIG_RETURN, RETURN, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:71:0x0119 A[SYNTHETIC, Splitter:B:71:0x0119] */
    /* JADX WARNING: Removed duplicated region for block: B:82:0x013c A[Catch:{ Exception -> 0x0124, all -> 0x0145 }] */
    ...
    public java.lang.String downloadUrlContent(android.os.AsyncTask r24, java.lang.String r25, java.util.HashMap<java.lang.String, java.lang.String> r26, boolean r27) {
        /*
            ...
            r11 = 0
            r12 = 0
            java.net.URL r13 = new java.net.URL     // Catch:{ all -> 0x015f }
            r14 = r25
            r13.<init>(r14)     // Catch:{ all -> 0x015d }
            java.net.URLConnection r15 = r13.openConnection()     // Catch:{ all -> 0x015d }
            r12 = r15
            r12.addRequestProperty(r7, r6)     // Catch:{ all -> 0x0153 }
            java.lang.String r15 = "gzip, deflate"
            r16 = r8
            java.lang.String r8 = "Accept-Encoding"
            if (r27 == 0) goto L_0x0038
            r12.addRequestProperty(r8, r15)     // Catch:{ all -> 0x0031 }
            goto L_0x0038
        L_0x0031:
            r0 = move-exception
            r20 = r10
            ...
            goto L_0x0168
        L_0x0038:
            r12.addRequestProperty(r5, r4)     // Catch:{ all -> 0x014b }
            r12.addRequestProperty(r3, r2)     // Catch:{ all -> 0x014b }
            r12.addRequestProperty(r1, r0)     // Catch:{ all -> 0x014b }
            if (r26 == 0) goto L_0x0084
            java.util.Set r17 = r26.entrySet()     // Catch:{ all -> 0x007d }
            java.util.Iterator r17 = r17.iterator()     // Catch:{ all -> 0x007d }
        L_0x004b:
            boolean r18 = r17.hasNext()     // Catch:{ all -> 0x007d }
            if (r18 == 0) goto L_0x0078
            java.lang.Object r18 = r17.next()     // Catch:{ all -> 0x007d }
            java.util.Map$Entry r18 = (java.util.Map.Entry) r18     // Catch:{ all -> 0x007d }
            java.lang.Object r19 = r18.getKey()     // Catch:{ all -> 0x007d }
            r20 = r10
            r10 = r19
            java.lang.String r10 = (java.lang.String) r10     // Catch:{ all -> 0x0073 }
            java.lang.Object r19 = r18.getValue()     // Catch:{ all -> 0x0073 }
            r21 = r11
            r11 = r19
            java.lang.String r11 = (java.lang.String) r11     // Catch:{ all -> 0x0145 }
            r12.addRequestProperty(r10, r11)     // Catch:{ all -> 0x0145 }
            r10 = r20
            r11 = r21
            goto L_0x004b
        L_0x0073:
        ...
        L_0x0088:
            ...
            r12.setConnectTimeout(r10)     // Catch:{ all -> 0x0147 }
            r12.setReadTimeout(r10)     // Catch:{ all -> 0x0147 }
            boolean r10 = r12 instanceof java.net.HttpURLConnection     // Catch:{ all -> 0x0147 }
            if (r10 == 0) goto L_0x0110
            r10 = r12
            java.net.HttpURLConnection r10 = (java.net.HttpURLConnection) r10     // Catch:{ all -> 0x0147 }
            r11 = 1
            r10.setInstanceFollowRedirects(r11)     // Catch:{ all -> 0x0147 }
            int r11 = r10.getResponseCode()     // Catch:{ all -> 0x0147 }
            r17 = r12
        ...
        L_0x00ad:
            ...
            java.lang.String r12 = r10.getHeaderField(r12)     // Catch:{ all -> 0x010b }
            r18 = r11
            java.lang.String r11 = "Set-Cookie"
            java.lang.String r11 = r10.getHeaderField(r11)     // Catch:{ all -> 0x010b }
            r19 = r10
            java.net.URL r10 = new java.net.URL     // Catch:{ all -> 0x010b }
            r10.<init>(r12)     // Catch:{ all -> 0x010b }
            r13 = r10
            java.net.URLConnection r10 = r13.openConnection()     // Catch:{ all -> 0x010b }
            r22 = r12
            java.lang.String r12 = "Cookie"
            r10.setRequestProperty(r12, r11)     // Catch:{ all -> 0x0107 }
            r10.addRequestProperty(r7, r6)     // Catch:{ all -> 0x0107 }
            if (r27 == 0) goto L_0x00d6
            r10.addRequestProperty(r8, r15)     // Catch:{ all -> 0x0107 }
        L_0x00d6:
            r10.addRequestProperty(r5, r4)     // Catch:{ all -> 0x0107 }
            r10.addRequestProperty(r3, r2)     // Catch:{ all -> 0x0107 }
            r10.addRequestProperty(r1, r0)     // Catch:{ all -> 0x0107 }
            if (r26 == 0) goto L_0x0105
            java.util.Set r0 = r26.entrySet()     // Catch:{ all -> 0x0107 }
            java.util.Iterator r0 = r0.iterator()     // Catch:{ all -> 0x0107 }
        L_0x00e9:
            boolean r1 = r0.hasNext()     // Catch:{ all -> 0x0107 }
            if (r1 == 0) goto L_0x0105
            java.lang.Object r1 = r0.next()     // Catch:{ all -> 0x0107 }
            java.util.Map$Entry r1 = (java.util.Map.Entry) r1     // Catch:{ all -> 0x0107 }
            java.lang.Object r2 = r1.getKey()     // Catch:{ all -> 0x0107 }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ all -> 0x0107 }
            java.lang.Object r3 = r1.getValue()     // Catch:{ all -> 0x0107 }
            java.lang.String r3 = (java.lang.String) r3     // Catch:{ all -> 0x0107 }
            r10.addRequestProperty(r2, r3)     // Catch:{ all -> 0x0107 }
            goto L_0x00e9
        L_0x0105:
            r12 = r10
            goto L_0x0114
        ...
        L_0x0112:
            r12 = r17
        L_0x0114:
            r12.connect()     // Catch:{ all -> 0x0145 }
            if (r27 == 0) goto L_0x013c
            java.util.zip.GZIPInputStream r0 = new java.util.zip.GZIPInputStream     // Catch:{ Exception -> 0x0124 }
            java.io.InputStream r1 = r12.getInputStream()     // Catch:{ Exception -> 0x0124 }
        ...
        L_0x012e:
        L_0x012f:
            java.net.URLConnection r0 = r13.openConnection()     // Catch:{ all -> 0x0145 }
            r12 = r0
            r12.connect()     // Catch:{ all -> 0x0145 }
            java.io.InputStream r0 = r12.getInputStream()     // Catch:{ all -> 0x0145 }
            goto L_0x0122
        L_0x013c:
            java.io.InputStream r0 = r12.getInputStream()     // Catch:{ all -> 0x0145 }
            r9 = r0
        ...
        L_0x01a1:
            ...
            boolean r0 = r12 instanceof java.net.HttpURLConnection     // Catch:{ Exception -> 0x01b5 }
            if (r0 == 0) goto L_0x01b4
            r0 = r12
            java.net.HttpURLConnection r0 = (java.net.HttpURLConnection) r0     // Catch:{ Exception -> 0x01b5 }
            int r0 = r0.getResponseCode()     // Catch:{ Exception -> 0x01b5 }
        ...
        L_0x01b9:
            ...
            byte[] r0 = new byte[r0]     // Catch:{ all -> 0x01f6 }
            r1 = r0
            r11 = r21
        L_0x01c3:
            boolean r0 = r24.isCancelled()     // Catch:{ all -> 0x01f4 }
            if (r0 == 0) goto L_0x01ca
            goto L_0x01ea
        L_0x01ca:
            int r0 = r9.read(r1)     // Catch:{ Exception -> 0x01ed }
            ...
            r11 = r2
        L_0x01d8:
            java.lang.String r2 = new java.lang.String     // Catch:{ Exception -> 0x01ed }
            r3 = 0
            java.nio.charset.Charset r4 = java.nio.charset.StandardCharsets.UTF_8     // Catch:{ Exception -> 0x01ed }
            r2.<init>(r1, r3, r0, r4)     // Catch:{ Exception -> 0x01ed }
            r11.append(r2)     // Catch:{ Exception -> 0x01ed }
            goto L_0x01c3
        L_0x01e4:
            r2 = -1
        ...
        L_0x01ed:
            r0 = move-exception
            im.bclpbkiauv.messenger.FileLog.e((java.lang.Throwable) r0)     // Catch:{ all -> 0x01f4 }
            r10 = r20
        L_0x01f3:
            goto L_0x0203
        L_0x01f4:
        ...
        L_0x021d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.messenger.utils.PlayerUtils.downloadUrlContent(android.os.AsyncTask, java.lang.String, java.util.HashMap, boolean):java.lang.String");
    }
    ...
    private class YoutubeVideoTask extends AsyncTask<Void, Void, String[]> {
        ...
        public java.lang.String[] doInBackground(java.lang.Void... r28) {
            /*
                ...
                im.bclpbkiauv.messenger.utils.PlayerUtils r0 = im.bclpbkiauv.messenger.utils.PlayerUtils.this
            ...
            L_0x0025:
                ...
                r0.append(r5)     // Catch:{ Exception -> 0x006b }
                java.lang.String r6 = "&eurl="
                r0.append(r6)     // Catch:{ Exception -> 0x006b }
                ...
                java.lang.String r7 = r1.videoId     // Catch:{ Exception -> 0x006b }
                r6.append(r7)     // Catch:{ Exception -> 0x006b }
                java.lang.String r6 = r6.toString()     // Catch:{ Exception -> 0x006b }
                java.lang.String r6 = java.net.URLEncoder.encode(r6, r2)     // Catch:{ Exception -> 0x006b }
                r0.append(r6)     // Catch:{ Exception -> 0x006b }
            ...
            L_0x006f:
                ...
                java.util.regex.Pattern r0 = im.bclpbkiauv.messenger.utils.PlayerUtils.stsPattern
            ...
            L_0x00c9:
                ...
                im.bclpbkiauv.messenger.utils.PlayerUtils r10 = im.bclpbkiauv.messenger.utils.PlayerUtils.this
            ...
            L_0x0109:
                ...
                java.lang.String[] r0 = r1.result     // Catch:{ Exception -> 0x0131 }
                r19 = 1
                r12 = r7[r19]     // Catch:{ Exception -> 0x0131 }
                java.lang.String r12 = java.net.URLDecoder.decode(r12, r2)     // Catch:{ Exception -> 0x0131 }
                r18 = 0
                r0[r18] = r12     // Catch:{ Exception -> 0x0131 }
                goto L_0x0135
            L_0x0131:
                r0 = move-exception
                im.bclpbkiauv.messenger.FileLog.e((java.lang.Throwable) r0)
            ...
            L_0x013b:
                ...
                r5 = 1
                r0 = r12[r5]     // Catch:{ Exception -> 0x01dc }
                java.lang.String r0 = java.net.URLDecoder.decode(r0, r2)     // Catch:{ Exception -> 0x01dc }
                java.lang.String r5 = "[&,]"
                java.lang.String[] r0 = r0.split(r5)     // Catch:{ Exception -> 0x01dc }
                r5 = 0
                r21 = 0
                r22 = 0
                r26 = r22
            ...
            L_0x016a:
                r23 = r6
                int r6 = r0.length     // Catch:{ Exception -> 0x01d8 }
                if (r5 >= r6) goto L_0x01d3
                r6 = r0[r5]     // Catch:{ Exception -> 0x01d8 }
                java.lang.String[] r6 = r6.split(r7)     // Catch:{ Exception -> 0x01d8 }
                r24 = r0
                r18 = 0
                r0 = r6[r18]     // Catch:{ Exception -> 0x01d8 }
                r25 = r8
                java.lang.String r8 = "type"
                boolean r0 = r0.startsWith(r8)     // Catch:{ Exception -> 0x01d1 }
                if (r0 == 0) goto L_0x0199
                r8 = 1
                r0 = r6[r8]     // Catch:{ Exception -> 0x01d1 }
                java.lang.String r0 = java.net.URLDecoder.decode(r0, r2)     // Catch:{ Exception -> 0x01d1 }
                java.lang.String r8 = "video/mp4"
                boolean r8 = r0.contains(r8)     // Catch:{ Exception -> 0x01d1 }
            ...
            L_0x021d:
                ...
                r6 = 1
                r0 = r5[r6]     // Catch:{ Exception -> 0x023b }
                java.lang.String r0 = java.net.URLDecoder.decode(r0, r2)     // Catch:{ Exception -> 0x023b }
                r16 = r0
                goto L_0x023f
            L_0x023b:
                r0 = move-exception
            ...
            L_0x02fe:
                ...
                r1.sig = r0
                r7 = 0
                java.util.regex.Pattern r0 = im.bclpbkiauv.messenger.utils.PlayerUtils.jsPattern
                java.util.regex.Matcher r8 = r0.matcher(r3)
                boolean r0 = r8.find()
                if (r0 == 0) goto L_0x0332
                org.json.JSONTokener r0 = new org.json.JSONTokener     // Catch:{ Exception -> 0x032e }
                r9 = 1
                java.lang.String r10 = r8.group(r9)     // Catch:{ Exception -> 0x032e }
                r0.<init>(r10)     // Catch:{ Exception -> 0x032e }
                java.lang.Object r9 = r0.nextValue()     // Catch:{ Exception -> 0x032e }
                boolean r10 = r9 instanceof java.lang.String     // Catch:{ Exception -> 0x032e }
                if (r10 == 0) goto L_0x032d
                r10 = r9
                java.lang.String r10 = (java.lang.String) r10     // Catch:{ Exception -> 0x032e }
                r7 = r10
            L_0x032d:
                goto L_0x0332
            L_0x032e:
            ...
            L_0x0332:
                ...
                java.util.regex.Pattern r0 = im.bclpbkiauv.messenger.utils.PlayerUtils.playerIdPattern
            ...
            L_0x03a1:
                ...
                java.lang.String r7 = r13.toString()
            L_0x03ba:
                im.bclpbkiauv.messenger.utils.PlayerUtils r13 = im.bclpbkiauv.messenger.utils.PlayerUtils.this
            ...
            L_0x03c8:
                ...
                java.util.regex.Pattern r15 = im.bclpbkiauv.messenger.utils.PlayerUtils.sigPattern
            ...
            L_0x03e1:
                r15 = 1
                java.util.regex.Pattern r14 = im.bclpbkiauv.messenger.utils.PlayerUtils.sigPattern2
            ...
            L_0x03f9:
                ...
                im.bclpbkiauv.messenger.utils.PlayerUtils$JSExtractor r0 = new im.bclpbkiauv.messenger.utils.PlayerUtils$JSExtractor     // Catch:{ Exception -> 0x0433 }
                im.bclpbkiauv.messenger.utils.PlayerUtils r15 = im.bclpbkiauv.messenger.utils.PlayerUtils.this     // Catch:{ Exception -> 0x0433 }
                r0.<init>(r13)     // Catch:{ Exception -> 0x0433 }
                java.lang.String r15 = r0.extractFunction(r14)     // Catch:{ Exception -> 0x0433 }
                r9 = r15
                boolean r15 = android.text.TextUtils.isEmpty(r9)     // Catch:{ Exception -> 0x0433 }
                if (r15 != 0) goto L_0x0430
                if (r8 == 0) goto L_0x0430
                android.content.SharedPreferences$Editor r15 = r11.edit()     // Catch:{ Exception -> 0x0433 }
                android.content.SharedPreferences$Editor r15 = r15.putString(r8, r9)     // Catch:{ Exception -> 0x0433 }
                r16 = r0
                java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0433 }
                r0.<init>()     // Catch:{ Exception -> 0x0433 }
                r0.append(r8)     // Catch:{ Exception -> 0x0433 }
                r0.append(r12)     // Catch:{ Exception -> 0x0433 }
                java.lang.String r0 = r0.toString()     // Catch:{ Exception -> 0x0433 }
                android.content.SharedPreferences$Editor r0 = r15.putString(r0, r14)     // Catch:{ Exception -> 0x0433 }
                r0.commit()     // Catch:{ Exception -> 0x0433 }
                goto L_0x0432
            L_0x0430:
                r16 = r0
            L_0x0432:
            ...
            L_0x046e:
                ...
                r0.append(r12)
                im.bclpbkiauv.messenger.utils.PlayerUtils r12 = im.bclpbkiauv.messenger.utils.PlayerUtils.this
            ...
            L_0x04a3:
                r12 = r9
                im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$YoutubeVideoTask$e9XxB6pZHJia7AV4QWwknKbcj7U r0 = new im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$YoutubeVideoTask$e9XxB6pZHJia7AV4QWwknKbcj7U     // Catch:{ Exception -> 0x04b3 }
                r0.<init>(r12)     // Catch:{ Exception -> 0x04b3 }
                im.bclpbkiauv.messenger.AndroidUtilities.runOnUIThread(r0)     // Catch:{ Exception -> 0x04b3 }
                java.util.concurrent.CountDownLatch r0 = r1.countDownLatch     // Catch:{ Exception -> 0x04b3 }
                r0.await()     // Catch:{ Exception -> 0x04b3 }
                r0 = 0
                goto L_0x04b8
            L_0x04b3:
                r0 = move-exception
            ...
            L_0x04c5:
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.messenger.utils.PlayerUtils.YoutubeVideoTask.doInBackground(java.lang.Void[]):java.lang.String[]");
        }

        public /* synthetic */ void lambda$doInBackground$1$PlayerUtils$YoutubeVideoTask(String functionCodeFinal) {
            ...
            try {
                ...
                WebView access$2000 = PlayerUtils.this.webView;
                access$2000.loadUrl("data:text/html;charset=utf-8;base64," + base64);
            } catch (Exception e) {
                FileLog.e((Throwable) e);
            }
        }

        public /* synthetic */ void lambda$null$0$PlayerUtils$YoutubeVideoTask(String value) {
        ...
        public void onPostExecute(String[] result2) {
            if (result2[0] != null) {
                ...
                boolean unused = PlayerUtils.this.initied = true;
                String unused2 = PlayerUtils.this.playVideoUrl = result2[0];
                String unused3 = PlayerUtils.this.playVideoType = result2[1];
                if (PlayerUtils.this.playVideoType.equals(DownloadAction.TYPE_HLS)) {
                    boolean unused4 = PlayerUtils.this.isStream = true;
                }
    ...
    private class VimeoVideoTask extends AsyncTask<Void, Void, String> {
        ...
        public String doInBackground(Void... voids) {
            String playerCode = PlayerUtils.this.downloadUrlContent(this, String.format(Locale.US, "https://player.vimeo.com/video/%s/config", new Object[]{this.videoId}));
            if (isCancelled()) {
                return null;
            }
            try {
        ...
        public void onPostExecute(String result) {
            if (result != null) {
                boolean unused = PlayerUtils.this.initied = true;
                String unused2 = PlayerUtils.this.playVideoUrl = result;
                String unused3 = PlayerUtils.this.playVideoType = this.results[1];
                if (PlayerUtils.this.isAutoplay) {
                    PlayerUtils.this.preparePlayer();
                }
                PlayerUtils.this.showProgress(false, true);
    ...
    private class AparatVideoTask extends AsyncTask<Void, Void, String> {
        ...
        /* access modifiers changed from: protected */
        public String doInBackground(Void... voids) {
            String playerCode = PlayerUtils.this.downloadUrlContent(this, String.format(Locale.US, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/%s", new Object[]{this.videoId}));
            if (isCancelled()) {
                return null;
            }
            try {
    ...
    private class TwitchClipVideoTask extends AsyncTask<Void, Void, String> {
        ...
        /* access modifiers changed from: protected */
        public String doInBackground(Void... voids) {
            String playerCode = PlayerUtils.this.downloadUrlContent(this, this.currentUrl, (HashMap<String, String>) null, false);
            if (isCancelled()) {
                return null;
            }
            try {
    ...
    private class TwitchStreamVideoTask extends AsyncTask<Void, Void, String> {
        ...
        public String doInBackground(Void... voids) {
            ...
            String streamCode = PlayerUtils.this.downloadUrlContent(this, String.format(Locale.US, "https://api.twitch.tv/kraken/streams/%s?stream_type=all", new Object[]{this.videoId}), headers, false);
            if (isCancelled()) {
                return null;
            }
            try {
                JSONObject jSONObject = new JSONObject(streamCode).getJSONObject("stream");
                JSONObject accessToken = new JSONObject(PlayerUtils.this.downloadUrlContent(this, String.format(Locale.US, "https://api.twitch.tv/api/channels/%s/access_token", new Object[]{this.videoId}), headers, false));
    ...
    private class CoubVideoTask extends AsyncTask<Void, Void, String> {
        ...
        /* access modifiers changed from: protected */
        public String doInBackground(Void... voids) {
            String playerCode = PlayerUtils.this.downloadUrlContent(this, String.format(Locale.US, "https://coub.com/api/v2/coubs/%s.json", new Object[]{this.videoId}));
            if (isCancelled()) {
                return null;
            }
            try {
        ...
        public void onPostExecute(String result) {
            if (result != null) {
                ...
                String unused2 = PlayerUtils.this.playVideoUrl = result;
                String unused3 = PlayerUtils.this.playVideoType = this.results[1];
                String unused4 = PlayerUtils.this.playAudioUrl = this.results[2];
                String unused5 = PlayerUtils.this.playAudioType = this.results[3];
                if (PlayerUtils.this.isAutoplay) {
                    PlayerUtils.this.preparePlayer();
                }
                PlayerUtils.this.showProgress(false, true);
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (PlayerUtils.this.drawImage) {
                if (PlayerUtils.this.firstFrameRendered && PlayerUtils.this.currentAlpha != 0.0f) {
                    ...
                    long unused = PlayerUtils.this.lastUpdateTime = newTime;
                    PlayerUtils playerUtils = PlayerUtils.this;
                    float unused2 = playerUtils.currentAlpha = playerUtils.currentAlpha - (((float) (newTime - PlayerUtils.this.lastUpdateTime)) / 150.0f);
                    if (PlayerUtils.this.currentAlpha < 0.0f) {
                        float unused3 = PlayerUtils.this.currentAlpha = 0.0f;
                    }
                    invalidate();
                }
            ...
            if (PlayerUtils.this.videoPlayer.isPlayerPrepared() && !PlayerUtils.this.isStream) {
                ...
                if (!PlayerUtils.this.isInline) {
                    ...
                    if (this.durationLayout != null) {
                        canvas.save();
                        canvas2.translate((float) ((width - AndroidUtilities.dp(58.0f)) - this.durationWidth), (float) (height - AndroidUtilities.dp((float) ((PlayerUtils.this.inFullscreen ? 6 : 10) + 29))));
                ...
                if (this.duration != 0) {
                    ...
                    if (i3 == 0 || (i = this.duration) == 0) {
                        ...
                        progressX2 = progressX;
                        canvas.drawRect((float) progressLineX, (float) progressLineY, ((float) progressLineX) + (((float) (progressLineEndX - progressLineX)) * (((float) i3) / ((float) i))), (float) (AndroidUtilities.dp(3.0f) + progressLineY), PlayerUtils.this.inFullscreen ? this.progressBufferedPaint : this.progressInnerPaint);
                    }
    ...
    public PlayerUtils(Context context, boolean allowInline, boolean allowShare, WebPlayerViewDelegate webPlayerViewDelegate) {
        ...
        this.surfaceTextureListener = new TextureView.SurfaceTextureListener() {
            ...
            public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
                ...
                if (PlayerUtils.this.switchingInlineMode) {
                    int unused = PlayerUtils.this.waitingForFirstTextureUpload = 2;
                }
                PlayerUtils.this.textureView.setSurfaceTexture(surface);
                PlayerUtils.this.textureView.setVisibility(0);
                boolean unused2 = PlayerUtils.this.changingTextureView = false;
                return false;
            }
                    ...
                    PlayerUtils.this.changedTextureView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                        public boolean onPreDraw() {
                            ...
                            if (PlayerUtils.this.textureImageView != null) {
                                ...
                                PlayerUtils.this.textureImageView.setImageDrawable((Drawable) null);
                                if (PlayerUtils.this.currentBitmap != null) {
                                    PlayerUtils.this.currentBitmap.recycle();
                                    Bitmap unused = PlayerUtils.this.currentBitmap = null;
                                }
                            }
                            AndroidUtilities.runOnUIThread(
                            /*  JADX ERROR: Method code generation error
                                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0052: INVOKE  
                                  (wrap: im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8 : 0x004f: CONSTRUCTOR  (r0v7 im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8) = 
                                  (r2v0 'this' im.bclpbkiauv.messenger.utils.PlayerUtils$2$1 A[THIS])
                                 call: im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8.<init>(im.bclpbkiauv.messenger.utils.PlayerUtils$2$1):void type: CONSTRUCTOR)
                                 im.bclpbkiauv.messenger.AndroidUtilities.runOnUIThread(java.lang.Runnable):void type: STATIC in method: im.bclpbkiauv.messenger.utils.PlayerUtils.2.1.onPreDraw():boolean, dex: classes2.dex
                                ...
                                Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x004f: CONSTRUCTOR  (r0v7 im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8) = 
                                  (r2v0 'this' im.bclpbkiauv.messenger.utils.PlayerUtils$2$1 A[THIS])
                                 call: im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8.<init>(im.bclpbkiauv.messenger.utils.PlayerUtils$2$1):void type: CONSTRUCTOR in method: im.bclpbkiauv.messenger.utils.PlayerUtils.2.1.onPreDraw():boolean, dex: classes2.dex
                                	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:256)
                                	at jadx.core.codegen.InsnGen.addWrappedArg(InsnGen.java:123)
                                	at jadx.core.codegen.InsnGen.addArg(InsnGen.java:107)
                                	at jadx.core.codegen.InsnGen.generateMethodArguments(InsnGen.java:787)
                                	...
                                	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:250)
                                	... 100 more
                                Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8, state: NOT_LOADED
                            ...
                            /*
                                this = this;
                                im.bclpbkiauv.messenger.utils.PlayerUtils$2 r0 = im.bclpbkiauv.messenger.utils.PlayerUtils.AnonymousClass2.this
                                im.bclpbkiauv.messenger.utils.PlayerUtils r0 = im.bclpbkiauv.messenger.utils.PlayerUtils.this
                            ...
                            L_0x004d:
                                im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8 r0 = new im.bclpbkiauv.messenger.utils.-$$Lambda$PlayerUtils$2$1$F3ehXeiTxpq3hzTdcjLpLJHWWy8
                                r0.<init>(r2)
                                ...
                                return r0
                            */
                            throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.messenger.utils.PlayerUtils.AnonymousClass2.AnonymousClass1.onPreDraw():boolean");
                        }
        ...
        this.switchToInlineRunnable = new Runnable() {
            public void run() {
                boolean unused = PlayerUtils.this.switchingInlineMode = false;
                if (PlayerUtils.this.currentBitmap != null) {
                    PlayerUtils.this.currentBitmap.recycle();
                    Bitmap unused2 = PlayerUtils.this.currentBitmap = null;
                }
                boolean unused3 = PlayerUtils.this.changingTextureView = true;
                if (PlayerUtils.this.textureImageView != null) {
                    try {
                        Bitmap unused4 = PlayerUtils.this.currentBitmap = Bitmaps.createBitmap(PlayerUtils.this.textureView.getWidth(), PlayerUtils.this.textureView.getHeight(), Bitmap.Config.ARGB_8888);
                        PlayerUtils.this.textureView.getBitmap(PlayerUtils.this.currentBitmap);
                    } catch (Throwable e) {
                        if (PlayerUtils.this.currentBitmap != null) {
                            PlayerUtils.this.currentBitmap.recycle();
                            Bitmap unused5 = PlayerUtils.this.currentBitmap = null;
                        }
                        FileLog.e(e);
                    }
                    if (PlayerUtils.this.currentBitmap != null) {
                ...
                boolean unused6 = PlayerUtils.this.isInline = true;
                ...
                PlayerUtils playerUtils = PlayerUtils.this;
                TextureView unused7 = playerUtils.changedTextureView = playerUtils.delegate.onSwitchInlineMode(PlayerUtils.this.controlsView, PlayerUtils.this.isInline, PlayerUtils.this.aspectRatioFrameLayout.getAspectRatio(), PlayerUtils.this.aspectRatioFrameLayout.getVideoRotation(), PlayerUtils.this.allowInlineAnimation);
        ...
        ScaleTextureView scaleTextureView = new ScaleTextureView(context2);
    ...
    public /* synthetic */ void lambda$new$0$PlayerUtils(String value) {
    ...
    public /* synthetic */ void lambda$new$1$PlayerUtils(View v) {
    ...
    public /* synthetic */ void lambda$new$2$PlayerUtils(View v) {
    ...
    public /* synthetic */ void lambda$new$3$PlayerUtils(View v) {
    ...
    public /* synthetic */ void lambda$new$4$PlayerUtils(View v) {
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void setTextureViewContainer(android.view.ViewGroup r5) {
        /*
            r4 = this;
            if (r5 != 0) goto L_0x0003
            return
        L_0x0003:
            im.bclpbkiauv.ui.hviews.ScaleTextureView r0 = r4.textureView
            android.view.ViewParent r0 = r0.getParent()
            android.view.ViewGroup r0 = (android.view.ViewGroup) r0
            if (r0 == 0) goto L_0x001b
            if (r0 == r5) goto L_0x001b
            im.bclpbkiauv.ui.hviews.ScaleTextureView r1 = r4.textureView
            r0.removeView(r1)
            r4.textureViewContainer = r5
            im.bclpbkiauv.ui.hviews.ScaleTextureView r1 = r4.textureView
            r5.addView(r1)
        L_0x001b:
            im.bclpbkiauv.ui.components.RadialProgressView r1 = r4.progressView
            ...
            r2 = 17
            r3 = 48
            android.widget.FrameLayout$LayoutParams r2 = im.bclpbkiauv.ui.components.LayoutHelper.createFrame((int) r3, (int) r3, (int) r2)
            r5.addView(r1, r2)
            r1 = 1
            r4.showProgress(r1, r1)
        L_0x0040:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.messenger.utils.PlayerUtils.setTextureViewContainer(android.view.ViewGroup):void");
    }
    ...
    public void showProgress(boolean show, boolean animated) {
        ...
        if (animated) {
            ...
            this.progressAnimation.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    AnimatorSet unused = PlayerUtils.this.progressAnimation = null;
                }
            });
