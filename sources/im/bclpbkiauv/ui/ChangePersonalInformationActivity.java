...
public class ChangePersonalInformationActivity extends BaseFragment implements ImageUpdater.ImageUpdaterDelegate, NotificationCenter.NotificationCenterDelegate {
    ...
    private void initView() {
        ...
        containerAvatarBg.setCornerRadius((float) AndroidUtilities.dp(10.0f));
        ...
        this.ivAvatar.setRoundRadius(AndroidUtilities.dp(10.0f));
        ...
        this.etNickName.setBackground(Theme.createRoundRectDrawable((float) AndroidUtilities.dp(28.0f), Theme.getColor(Theme.key_windowBackgroundGray)));
        this.etNickName.setFilters(new InputFilter[]{new MaxByteLengthFilter(), $$Lambda$ChangePersonalInformationActivity$eLT98VdCTUhZWNfqkdv5lyKu6Nc.INSTANCE});
        this.etNickName.addTextChangedListener(this.etNameWatcher);
        this.selectDataOfBirthParent.setBackground(Theme.createRoundRectDrawable((float) AndroidUtilities.dp(28.0f), Theme.getColor(Theme.key_windowBackgroundGray)));
        ...
        this.containerGenderSelect.setVisibility(8);
    ...
    @OnClick({2131296479, 2131296488, 2131296484, 2131297645, 2131296411})
    ...
    private void signUp(String ip2, String country2, String city2) {
        ...
        sb.append("extj = ");
        sb.append(extendJson != null ? extendJson.toJSONString() : "null");
        FileLog.d(simpleName, sb.toString());
        if (extendJson != null) {
        ...
        AlertDialog progressDialog = new AlertDialog(getParentActivity(), 3);
        showDialog(progressDialog);
        Log.e(BuildConfig.BUILD_TYPE, "req==" + JSONObject.toJSONString(req));
        ConnectionsManager instance = ConnectionsManager.getInstance(this.currentAccount);
        int reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate(progressDialog) {
            private final /* synthetic */ AlertDialog f$1;
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ChangePersonalInformationActivity.this.lambda$signUp$6$ChangePersonalInformationActivity(this.f$1, tLObject, tL_error);
            }
        }, 10);
        instance.bindRequestToGuid(reqId, this.classGuid);
        progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener(reqId) {
    ...
    public /* synthetic */ void lambda$signUp$6$ChangePersonalInformationActivity(AlertDialog progressDialog, TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new Runnable(progressDialog, error, response) {
            ...
            public final void run() {
                ChangePersonalInformationActivity.this.lambda$null$5$ChangePersonalInformationActivity(this.f$1, this.f$2, this.f$3);
            }
        });
    }

    public /* synthetic */ void lambda$null$5$ChangePersonalInformationActivity(AlertDialog progressDialog, TLRPC.TL_error error, TLObject response) {
        progressDialog.dismiss();
    ...
    private void parseError(TLRPC.TL_error error) {
        ...
        } else if (error.text.contains("SAME_IP_LIMIT")) {
            needShowAlert(LocaleController.getString("SameIpOrDeLimit", R.string.SameIpOrDeLimit), true, (DialogInterface.OnClickListener) null);
    ...
    public boolean back() {
        ...
        builder.setNegativeButton(LocaleController.getString("Stop", R.string.Stop), new DialogInterface.OnClickListener() {
            public final void onClick(DialogInterface dialogInterface, int i) {
                ChangePersonalInformationActivity.this.lambda$back$17$ChangePersonalInformationActivity(dialogInterface, i);
            }
        });
    ...
    public /* synthetic */ void lambda$back$17$ChangePersonalInformationActivity(DialogInterface dialogInterface, int i) {
        saveCurrentState();
        finishFragment();
    }
