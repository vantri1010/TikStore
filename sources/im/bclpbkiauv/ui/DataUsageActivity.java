...
import im.bclpbkiauv.ui.DataUsageActivity;
...
public class DataUsageActivity extends BaseFragment {
    ...
    public static final Interpolator interpolator = $$Lambda$DataUsageActivity$waqILapA8HJZdO21ZFGSIaVYikA.INSTANCE;
    /* access modifiers changed from: private */
    ...
    public View createView(Context context) {
            ...
            public boolean onTouchEvent(MotionEvent ev) {
                ...
                if (ev != null && ev.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                    ...
                    if (this.startedTracking) {
                        ...
                        boolean unused2 = DataUsageActivity.this.backAnimation = Math.abs(x) < ((float) DataUsageActivity.this.viewPages[0].getMeasuredWidth()) / 3.0f && (Math.abs(velX2) < 3500.0f || Math.abs(velX2) < Math.abs(this.velocityTracker.getYVelocity()));
                        if (DataUsageActivity.this.backAnimation) {
                            dx = Math.abs(x);
                            if (DataUsageActivity.this.animatingForward) {
                        ...
                        DataUsageActivity.this.tabsAnimation.setDuration((long) Math.max(150, Math.min(duration, BannerConfig.SCROLL_TIME)));
        ...
        while (true) {
            ...
            this.viewPages[a].listView.setOnItemClickListener((RecyclerListView.OnItemClickListener) new RecyclerListView.OnItemClickListener(listView) {
    ...
    public /* synthetic */ void lambda$createView$2$DataUsageActivity(RecyclerListView listView, View view, int position) {
        if (getParentActivity() != null) {
            ...
            if (position == adapter.resetRow) {
                ...
                builder.setPositiveButton(LocaleController.getString("Reset", R.string.Reset), new DialogInterface.OnClickListener(adapter) {
    ...
    public /* synthetic */ void lambda$null$1$DataUsageActivity(ListAdapter adapter, DialogInterface dialogInterface, int i) {
    ...
    private void updateTabs() {
        ...
        if (scrollSlidingTextTabStrip2 != null) {
            scrollSlidingTextTabStrip2.addTextTab(0, LocaleController.getString("NetworkUsageMobile", R.string.NetworkUsageMobile));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (itemViewType != 0) {
                ...
                if (itemViewType == 1) {
                    ...
                    if (position == this.callsSentRow) {
                        ...
                        int total2 = total - (hours * 3600);
                        int minutes = total2 / 60;
                        int total3 = total2 - (minutes * 60);
                        if (hours != 0) {
                            time = String.format("%d:%02d:%02d", new Object[]{Integer.valueOf(hours), Integer.valueOf(minutes), Integer.valueOf(total3)});
                        } else {
                            time = String.format("%d:%02d", new Object[]{Integer.valueOf(minutes), Integer.valueOf(total3)});
                        }
                        ...
                        if (position != this.totalBytesReceivedRow) {
                            z = true;
                        }
            ...
            } else if (position == this.resetSection2Row) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        while (true) {
            ...
            arrayList.add(new ThemeDescription(viewPageArr[a].listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{TextSettingsCell.class, HeaderCell.class}, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhite));
            arrayList.add(new ThemeDescription(this.viewPages[a].listView, ThemeDescription.FLAG_LISTGLOWCOLOR, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_actionBarDefault));
            arrayList.add(new ThemeDescription(this.viewPages[a].listView, ThemeDescription.FLAG_SELECTOR, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_listSelector));
            arrayList.add(new ThemeDescription(this.viewPages[a].listView, 0, new Class[]{View.class}, Theme.dividerPaint, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_divider));
            arrayList.add(new ThemeDescription(this.viewPages[a].listView, ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{ShadowSectionCell.class}, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundGrayShadow));
            arrayList.add(new ThemeDescription((View) this.viewPages[a].listView, 0, new Class[]{HeaderCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteBlueHeader));
            arrayList.add(new ThemeDescription(this.viewPages[a].listView, ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{TextInfoPrivacyCell.class}, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundGrayShadow));
            arrayList.add(new ThemeDescription((View) this.viewPages[a].listView, 0, new Class[]{TextInfoPrivacyCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteGrayText4));
            arrayList.add(new ThemeDescription((View) this.viewPages[a].listView, ThemeDescription.FLAG_CHECKTAG, new Class[]{TextSettingsCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteBlackText));
            arrayList.add(new ThemeDescription((View) this.viewPages[a].listView, 0, new Class[]{TextSettingsCell.class}, new String[]{"valueTextView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteValueText));
            arrayList.add(new ThemeDescription((View) this.viewPages[a].listView, ThemeDescription.FLAG_CHECKTAG, new Class[]{TextSettingsCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteRedText2));
            a++;
        }
    }
}
