...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.fragmentView.setOnTouchListener($$Lambda$IdenticonActivity$w3Dj18HoAclBA82XN9fptNS_1RA.INSTANCE);
        ...
        AnonymousClass2 r5 = new FrameLayout(context2) {
        ...
        textView4.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText4));
        ...
        if (encryptedChat != null) {
            ...
            if (encryptedChat.key_hash.length > 16) {
                ...
                for (int a2 = 0; a2 < 5; a2++) {
                    int num = ((encryptedChat.key_hash[(a2 * 4) + 16] & ByteCompanionObject.MAX_VALUE) << 24) | ((encryptedChat.key_hash[((a2 * 4) + 16) + 1] & UByte.MAX_VALUE) << 16) | ((encryptedChat.key_hash[((a2 * 4) + 16) + 2] & UByte.MAX_VALUE) << 8) | (encryptedChat.key_hash[(a2 * 4) + 16 + 3] & 255);
                    if (a2 != 0) {
                        emojis.append(" ");
                    }
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        TextView textView2;
        if (id == NotificationCenter.emojiDidLoad && (textView2 = this.emojiTextView) != null) {
