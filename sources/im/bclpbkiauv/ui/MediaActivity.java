...
public class MediaActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final Interpolator interpolator = $$Lambda$MediaActivity$9vHVfKYL7cAfvTIujkKzJx7I_Xk.INSTANCE;
    ...
    /* access modifiers changed from: private */
    public MrySearchView mrySearchView;
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            public void onItemClick(int id) {
                ...
                if (i == -1) {
                    if (MediaActivity.this.actionBar.isActionModeShowed()) {
                        ...
                        int unused = MediaActivity.this.cantDeleteMessagesCount = 0;
                    ...
                    AlertsCreator.createDeleteMessagesAlert(mediaActivity, currentUser, currentChat, currentEncryptedChat, (TLRPC.ChatFull) null, mediaActivity.mergeDialogId, (MessageObject) null, MediaActivity.this.selectedFiles, (MessageObject.GroupedMessages) null, false, 1, new Runnable() {
                    ...
                    fragment.setDelegate(new DialogsActivity.DialogsActivityDelegate() {
                        public final void didSelectDialogs(DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z) {
                            MediaActivity.AnonymousClass4.this.lambda$onItemClick$1$MediaActivity$4(dialogsActivity, arrayList, charSequence, z);
                        }
                    });
            ...
            public /* synthetic */ void lambda$onItemClick$1$MediaActivity$4(DialogsActivity fragment1, ArrayList dids, CharSequence message, boolean param) {
                ...
                if (dids.size() > 1 || ((Long) arrayList.get(0)).longValue() == ((long) UserConfig.getInstance(MediaActivity.this.currentAccount).getClientUserId())) {
                    ...
                    } else if (!MessagesController.getInstance(MediaActivity.this.currentAccount).checkCanOpenChat(args1, fragment1)) {
                        return;
                    }
                    NotificationCenter.getInstance(MediaActivity.this.currentAccount).postNotificationName(NotificationCenter.closeChats, new Object[0]);
                ...
                for (int a2 = 0; a2 < dids.size(); a2++) {
                    ...
                    if (message != null) {
                        SendMessagesHelper.getInstance(MediaActivity.this.currentAccount).sendMessage(message.toString(), did2, (MessageObject) null, (TLRPC.WebPage) null, true, (ArrayList<TLRPC.MessageEntity>) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0);
                    }
                    SendMessagesHelper.getInstance(MediaActivity.this.currentAccount).sendMessage(fmessages, did2, true, 0);
                }
        ...
        ScrollSlidingTextTabStrip scrollSlidingTextTabStrip3 = new ScrollSlidingTextTabStrip(context2, 2);
        this.scrollSlidingTextTabStrip = scrollSlidingTextTabStrip3;
        scrollSlidingTextTabStrip3.setColors(Theme.key_chats_pinnedIcon, Theme.key_chat_inLoader, Theme.key_windowBackgroundWhiteGrayText3, (String) null);
        this.scrollSlidingTextTabStrip.setBackground(Theme.createRoundRectDrawable((float) AndroidUtilities.dp(5.0f), Theme.getColor(Theme.key_windowBackgroundWhite)));
        ...
        this.scrollSlidingTextTabStrip.setDelegate(new ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate() {
            public void onPageSelected(int id, boolean forward) {
                if (MediaActivity.this.mediaPages[0].selectedType != id) {
                    MediaActivity mediaActivity = MediaActivity.this;
                    boolean unused = mediaActivity.swipeBackEnabled = id == mediaActivity.scrollSlidingTextTabStrip.getFirstTabId();
                    int unused2 = MediaActivity.this.mediaPages[1].selectedType = id;
                    MediaActivity.this.mediaPages[1].setVisibility(0);
                    MediaActivity.this.switchToCurrentSelectedMode(true);
                    boolean unused3 = MediaActivity.this.animatingForward = forward;
                }
            }
            ...
            public void onPageScrolled(float progress) {
                if (progress != 1.0f || MediaActivity.this.mediaPages[1].getVisibility() == 0) {
                    ...
                    if (progress == 1.0f) {
                        ...
                        int unused = MediaActivity.this.searchItemState = 0;
                    }
                }
            }
        });
        ...
        this.selectedMessagesCountTextView.setOnTouchListener($$Lambda$MediaActivity$xE47SeXJENfVZzo7JQqq3KzG75s.INSTANCE);
        ...
        LinearLayout r3 = new LinearLayout(context2) {
            ...
            public boolean checkTabsAnimationInProgress() {
                ...
                if (MediaActivity.this.backAnimation) {
                    if (Math.abs(MediaActivity.this.mediaPages[0].getTranslationX()) < 1.0f) {
                        ...
                        MediaPage mediaPage = MediaActivity.this.mediaPages[1];
                        int measuredWidth = MediaActivity.this.mediaPages[0].getMeasuredWidth();
                        if (MediaActivity.this.animatingForward) {
                            i = 1;
                        }
                    ...
                    int measuredWidth2 = MediaActivity.this.mediaPages[0].getMeasuredWidth();
                    if (!MediaActivity.this.animatingForward) {
                        i = 1;
                    }
                ...
                if (cancel) {
                    if (MediaActivity.this.tabsAnimation != null) {
                        ...
                        AnimatorSet unused = MediaActivity.this.tabsAnimation = null;
                    }
                    boolean unused2 = MediaActivity.this.tabsAnimationInProgress = false;
                }
            ...
            public boolean onTouchEvent(MotionEvent ev) {
                ...
                if (ev != null && ev.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                    ...
                    if (this.maybeStartTracking && !this.startedTracking) {
                        ...
                        MediaActivity.this.mediaPages[0].setTranslationX((float) dx2);
                        if (MediaActivity.this.animatingForward) {
                            MediaActivity.this.mediaPages[1].setTranslationX((float) (MediaActivity.this.mediaPages[0].getMeasuredWidth() + dx2));
                        } else {
                            MediaActivity.this.mediaPages[1].setTranslationX((float) (dx2 - MediaActivity.this.mediaPages[0].getMeasuredWidth()));
                        }
                        float scrollProgress = ((float) Math.abs(dx2)) / ((float) MediaActivity.this.mediaPages[0].getMeasuredWidth());
                        if (MediaActivity.this.searchItemState == 2) {
                    ...
                    if (this.startedTracking) {
                        ...
                        AnimatorSet unused = MediaActivity.this.tabsAnimation = new AnimatorSet();
                        float velX2 = this.velocityTracker.getXVelocity();
                        boolean unused2 = MediaActivity.this.backAnimation = Math.abs(x) < ((float) MediaActivity.this.mediaPages[0].getMeasuredWidth()) / 3.0f && (Math.abs(velX2) < 3500.0f || Math.abs(velX2) < Math.abs(this.velocityTracker.getYVelocity()));
                        if (MediaActivity.this.backAnimation) {
                            dx = Math.abs(x);
                            if (MediaActivity.this.animatingForward) {
                            ...
                            dx = ((float) MediaActivity.this.mediaPages[0].getMeasuredWidth()) - Math.abs(x);
                            if (MediaActivity.this.animatingForward) {
                        ...
                        MediaActivity.this.tabsAnimation.setDuration((long) Math.max(150, Math.min(duration, BannerConfig.SCROLL_TIME)));
                        MediaActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() {
                            public void onAnimationEnd(Animator animator) {
                                ...
                                if (MediaActivity.this.backAnimation) {
                                    ...
                                    int unused2 = MediaActivity.this.searchItemState = 0;
                                } else {
                                    MediaPage tempPage = MediaActivity.this.mediaPages[0];
                                    MediaActivity.this.mediaPages[0] = MediaActivity.this.mediaPages[1];
                                    MediaActivity.this.mediaPages[1] = tempPage;
                                    ...
                                    int unused3 = MediaActivity.this.searchItemState = 0;
                                    boolean unused4 = MediaActivity.this.swipeBackEnabled = MediaActivity.this.mediaPages[0].selectedType == MediaActivity.this.scrollSlidingTextTabStrip.getFirstTabId();
                                    MediaActivity.this.scrollSlidingTextTabStrip.selectTabWithId(MediaActivity.this.mediaPages[0].selectedType, 1.0f);
                                }
                                boolean unused5 = MediaActivity.this.tabsAnimationInProgress = false;
                                boolean unused6 = AnonymousClass6.this.maybeStartTracking = false;
                                boolean unused7 = AnonymousClass6.this.startedTracking = false;
                        ...
                        boolean unused3 = MediaActivity.this.tabsAnimationInProgress = true;
                    } else {
                        this.maybeStartTracking = false;
                        this.startedTracking = false;
                        MediaActivity.this.actionBar.setEnabled(true);
        ...
        linearLayout.addView(this.actionBar, LayoutHelper.createFrame(-1, -2.0f));
        ...
        MrySearchView mrySearchView2 = new MrySearchView(context2);
        this.mrySearchView = mrySearchView2;
        mrySearchView2.setiSearchViewDelegate(new MrySearchView.ISearchViewDelegate() {
            public void onStart(boolean focus) {
            }

            public void onSearchExpand() {
                boolean unused = MediaActivity.this.searching = true;
            }
            ...
            public void onSearchCollapse() {
                boolean unused = MediaActivity.this.searching = false;
                boolean unused2 = MediaActivity.this.searchWas = false;
                ...
                if (MediaActivity.this.ignoreSearchCollapse) {
                    boolean unused3 = MediaActivity.this.ignoreSearchCollapse = false;
                } else {
            ...
            public void onTextChange(String text) {
                if (text.length() != 0) {
                    boolean unused = MediaActivity.this.searchWas = true;
                    MediaActivity.this.switchToCurrentSelectedMode(false);
                } else {
                    boolean unused2 = MediaActivity.this.searchWas = false;
                    MediaActivity.this.switchToCurrentSelectedMode(false);
        ...
        linearLayout.addView(this.mrySearchView, searchlayoutParams);
        ...
        linearLayout.addView(this.scrollSlidingTextTabStrip, layoutParams);
        FrameLayout contentcontainer = new FrameLayout(context2) {
            private boolean globalIgnoreLayout;
                ...
                for (int a = 0; a < MediaActivity.this.mediaPages.length; a++) {
                    if (MediaActivity.this.mediaPages[a] != null) {
                        if (MediaActivity.this.mediaPages[a].listView != null) {
                            MediaActivity.this.mediaPages[a].listView.setPadding(0, MediaActivity.this.additionalPadding + fragmentContextViewheight, 0, AndroidUtilities.dp(4.0f));
                        }
                        if (MediaActivity.this.mediaPages[a].emptyView != null) {
                            MediaActivity.this.mediaPages[a].emptyView.setPadding(0, MediaActivity.this.additionalPadding + fragmentContextViewheight, 0, 0);
                        }
                        if (MediaActivity.this.mediaPages[a].progressView != null) {
                            MediaActivity.this.mediaPages[a].progressView.setPadding(0, MediaActivity.this.additionalPadding + fragmentContextViewheight, 0, 0);
                        }
                    }
                }
            ...
            public void setPadding(int left, int top, int right, int bottom) {
                int unused = MediaActivity.this.additionalPadding = top;
                int fragmentContextViewheight = MediaActivity.this.fragmentContextView.getMeasuredHeight();
                if (MediaActivity.this.fragmentContextView != null) {
                    MediaActivity.this.fragmentContextView.setTranslationY((float) (MediaActivity.this.fragmentContextView.getMeasuredHeight() + top));
                }
                for (int a = 0; a < MediaActivity.this.mediaPages.length; a++) {
                    if (MediaActivity.this.mediaPages[a] != null) {
                        if (MediaActivity.this.mediaPages[a].emptyView != null) {
        ...
        linearLayout.addView(contentcontainer, LayoutHelper.createLinear(-1, -1));
        ...
        while (true) {
            ...
            final LinearLayoutManager layoutManager = mediaPageArr2[a3].layoutManager = new LinearLayoutManager(context2, 1, false) {
            ...
            this.mediaPages[a3].listView.setOnItemClickListener((RecyclerListView.OnItemClickListener) new RecyclerListView.OnItemClickListener(mediaPage) {
                private final /* synthetic */ MediaActivity.MediaPage f$1;
                ...
                public final void onItemClick(View view, int i) {
                    MediaActivity.this.lambda$createView$2$MediaActivity(this.f$1, view, i);
                }
            });
            this.mediaPages[a3].listView.setOnScrollListener(new RecyclerView.OnScrollListener() {
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    ...
                    boolean unused = MediaActivity.this.scrolling = newState != 0;
                    if (newState != 1) {
                    ...
                    if (!MediaActivity.this.searching || !MediaActivity.this.searchWas) {
                        ...
                        if (visibleItemCount != 0 && firstVisibleItem + visibleItemCount > totalItemCount - 2 && !MediaActivity.this.sharedMediaData[mediaPage.selectedType].loading) {
                            ...
                            if (!MediaActivity.this.sharedMediaData[mediaPage.selectedType].endReached[0]) {
                                boolean unused = MediaActivity.this.sharedMediaData[mediaPage.selectedType].loading = true;
                                ...
                                boolean unused2 = MediaActivity.this.sharedMediaData[mediaPage.selectedType].loading = true;
            ...
            this.mediaPages[a3].listView.setOnItemLongClickListener((RecyclerListView.OnItemLongClickListener) new RecyclerListView.OnItemLongClickListener(mediaPage) {
                ...
                public final boolean onItemClick(View view, int i) {
                    return MediaActivity.this.lambda$createView$3$MediaActivity(this.f$1, view, i);
                }
            });
            ...
            this.mediaPages[a3].emptyView.setOnTouchListener($$Lambda$MediaActivity$yBXvg9MmjBf6Ao5NdoR1bdkjqLA.INSTANCE);
        ...
        LinearLayout.LayoutParams layoutParams2 = searchlayoutParams;
        ...
        if (!AndroidUtilities.isTablet()) {
            ...
            contentcontainer.addView(fragmentContextView2, LayoutHelper.createFrame(-1.0f, 39.0f, 51, 0.0f, 8.0f, 0.0f, 0.0f));
        }
        updateTabs();
    ...
    public void switchToCurrentSelectedMode(boolean animated) {
        ...
        if (!this.searching || !this.searchWas) {
            ...
            this.mediaPages[a2].emptyTextView.setPadding(AndroidUtilities.dp(40.0f), 0, AndroidUtilities.dp(40.0f), AndroidUtilities.dp(90.0f));
            ...
            String text = this.mrySearchView.getEditor().getText().toString();
            if (this.mediaPages[a2].selectedType == 1) {
    ...
    private class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < MediaActivity.this.sharedMediaData[3].sections.size()) {
                ((GraySectionCell) view).setText(LocaleController.formatSectionDate((long) ((ArrayList) MediaActivity.this.sharedMediaData[3].sectionArrays.get((String) MediaActivity.this.sharedMediaData[3].sections.get(section))).get(0).messageOwner.date));
            }
            return view;
        }
    ...
    private class SharedDocumentsAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < MediaActivity.this.sharedMediaData[this.currentType].sections.size()) {
                ((GraySectionCell) view).setText(LocaleController.formatSectionDate((long) ((ArrayList) MediaActivity.this.sharedMediaData[this.currentType].sectionArrays.get((String) MediaActivity.this.sharedMediaData[this.currentType].sections.get(section))).get(0).messageOwner.date));
            }
            return view;
        }
            ...
            if (holder.getItemViewType() != 2) {
                ...
                if (itemViewType == 0) {
                    ...
                    if (MediaActivity.this.actionBar.isActionModeShowed()) {
                        ...
                        sharedAudioCell.setChecked(z, true ^ MediaActivity.this.scrolling);
                        return;
                    }
    ...
    private class SharedPhotoVideoAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < MediaActivity.this.sharedMediaData[0].sections.size()) {
                ((SharedMediaSectionCell) view).setText(LocaleController.formatSectionDate((long) ((ArrayList) MediaActivity.this.sharedMediaData[0].sectionArrays.get((String) MediaActivity.this.sharedMediaData[0].sections.get(section))).get(0).messageOwner.date));
            }
            return view;
        }
                ...
                if (itemViewType == 0) {
                    ...
                    for (int a = 0; a < MediaActivity.this.columnsCount; a++) {
                        ...
                        if (index < messageObjects.size()) {
                            ...
                            if (MediaActivity.this.actionBar.isActionModeShowed()) {
                                cell.setChecked(a, MediaActivity.this.selectedFiles[(messageObject.getDialogId() > MediaActivity.this.dialog_id ? 1 : (messageObject.getDialogId() == MediaActivity.this.dialog_id ? 0 : -1)) == 0 ? (char) 0 : 1].indexOfKey(messageObject.getId()) >= 0, !MediaActivity.this.scrolling);
                            } else {
    ...
    public class MediaSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void queryServerSearch(String query, int max_id, long did) {
            ...
            if (uid != 0) {
                ...
                if (req.peer != null) {
                    ...
                    this.searchesInProgress++;
                    this.reqId = ConnectionsManager.getInstance(MediaActivity.this.currentAccount).sendRequest(req, new RequestDelegate(max_id, currentReqId) {
        ...
        public /* synthetic */ void lambda$queryServerSearch$1$MediaActivity$MediaSearchAdapter(int max_id, int currentReqId, TLObject response, TLRPC.TL_error error) {
            ...
            for (int a = 0; a < MediaActivity.this.mediaPages.length; a++) {
                if (MediaActivity.this.mediaPages[a].selectedType == this.currentType) {
                    if (getItemCount() != 0) {
                        ...
                        MediaActivity.this.mediaPages[a].listView.setEmptyView((View) null);
                        MediaActivity.this.mediaPages[a].emptyView.setVisibility(8);
                        MediaActivity.this.mediaPages[a].progressView.setVisibility(0);
                    }
                }
            }
            $$Lambda$MediaActivity$MediaSearchAdapter$rpvC3kWmbGYv1zk7D2Jlj7plQo r0 = new Runnable(query) {
                private final /* synthetic */ String f$1;
        ...
        public /* synthetic */ void lambda$search$3$MediaActivity$MediaSearchAdapter(String query) {
            int i;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (i == 1) {
                ...
                if (MediaActivity.this.actionBar.isActionModeShowed()) {
                    if (MediaActivity.this.selectedFiles[messageObject3.getDialogId() == MediaActivity.this.dialog_id ? (char) 0 : 1].indexOfKey(messageObject3.getId()) >= 0) {
                        z = true;
                    }
                    sharedAudioCell.setChecked(z, true ^ MediaActivity.this.scrolling);
                    return;
