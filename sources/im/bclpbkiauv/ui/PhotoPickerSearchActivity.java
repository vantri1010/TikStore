...
public class PhotoPickerSearchActivity extends BaseFragment {
    ...
    public static final Interpolator interpolator = $$Lambda$PhotoPickerSearchActivity$Njgo_R5YCIDosEcE_A7ys6z7mQY.INSTANCE;
    ...
    public PhotoPickerSearchActivity(HashMap<Object, Object> selectedPhotos, ArrayList<Object> selectedPhotosOrder, ArrayList<MediaController.SearchImage> recentImages, int selectPhotoType2, boolean allowCaption, ChatActivity chatActivity2) {
        this.imagesSearch = new PhotoPickerActivity(0, (MediaController.AlbumEntry) null, selectedPhotos, selectedPhotosOrder, recentImages, selectPhotoType2, allowCaption, chatActivity2);
        this.gifsSearch = new PhotoPickerActivity(1, (MediaController.AlbumEntry) null, selectedPhotos, selectedPhotosOrder, recentImages, selectPhotoType2, allowCaption, chatActivity2);
    }
        ...
        SizeNotifierFrameLayout r4 = new SizeNotifierFrameLayout(context2) {
            ...
            public void onMeasure(int r17, int r18) {
                /*
                    ...
                    im.bclpbkiauv.ui.PhotoPickerSearchActivity r0 = im.bclpbkiauv.ui.PhotoPickerSearchActivity.this
                    ...
                    boolean r0 = im.bclpbkiauv.messenger.AndroidUtilities.isInMultiwindow
                    if (r0 != 0) goto L_0x0051
                    im.bclpbkiauv.ui.PhotoPickerSearchActivity r0 = im.bclpbkiauv.ui.PhotoPickerSearchActivity.this
                    im.bclpbkiauv.ui.components.EditTextEmoji r0 = r0.commentTextView
                ...
                L_0x0054:
                    ...
                    r0 = 0
                L_0x0061:
                    im.bclpbkiauv.ui.PhotoPickerSearchActivity r2 = im.bclpbkiauv.ui.PhotoPickerSearchActivity.this
                    im.bclpbkiauv.ui.PhotoPickerSearchActivity$ViewPage[] r2 = r2.viewPages
                    int r2 = r2.length
                ...
                L_0x0075:
                    ...
                    im.bclpbkiauv.ui.PhotoPickerSearchActivity$ViewPage[] r2 = r2.viewPages
                    r2 = r2[r0]
                    im.bclpbkiauv.ui.components.RecyclerListView r2 = r2.listView
                    ...
                    int r5 = r5 + r12
                    int r13 = im.bclpbkiauv.messenger.AndroidUtilities.dp(r3)
                ...
                L_0x0110:
                    ...
                    int r2 = im.bclpbkiauv.messenger.AndroidUtilities.statusBarHeight
                    int r2 = r11 - r2
                ...
                L_0x014d:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.ui.PhotoPickerSearchActivity.AnonymousClass4.onMeasure(int, int):void");
            }
            ...
            public boolean onTouchEvent(MotionEvent ev) {
                ...
                if (ev != null && ev.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                    ...
                    if (this.startedTracking) {
                        ...
                        boolean unused2 = PhotoPickerSearchActivity.this.backAnimation = Math.abs(x) < ((float) PhotoPickerSearchActivity.this.viewPages[0].getMeasuredWidth()) / 3.0f && (Math.abs(velX2) < 3500.0f || Math.abs(velX2) < Math.abs(this.velocityTracker.getYVelocity()));
                        if (PhotoPickerSearchActivity.this.backAnimation) {
                            dx = Math.abs(x);
                            if (PhotoPickerSearchActivity.this.animatingForward) {
                        ...
                        PhotoPickerSearchActivity.this.tabsAnimation.setDuration((long) Math.max(150, Math.min(duration, BannerConfig.SCROLL_TIME)));
    ...
    private void updateTabs() {
        ...
        if (scrollSlidingTextTabStrip2 != null) {
            scrollSlidingTextTabStrip2.addTextTab(0, LocaleController.getString("ImagesTab", R.string.ImagesTab));
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(this.fragmentView, ThemeDescription.FLAG_BACKGROUND, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogBackground));
        arrayList.add(new ThemeDescription(this.actionBar, ThemeDescription.FLAG_BACKGROUND, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogBackground));
        arrayList.add(new ThemeDescription(this.actionBar, ThemeDescription.FLAG_AB_ITEMSCOLOR, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogTextBlack));
        arrayList.add(new ThemeDescription(this.actionBar, ThemeDescription.FLAG_AB_TITLECOLOR, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogTextBlack));
        arrayList.add(new ThemeDescription(this.actionBar, ThemeDescription.FLAG_AB_SELECTORCOLOR, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogButtonSelector));
        arrayList.add(new ThemeDescription(this.actionBar, ThemeDescription.FLAG_AB_SEARCH, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogTextBlack));
        arrayList.add(new ThemeDescription(this.actionBar, ThemeDescription.FLAG_AB_SEARCHPLACEHOLDER, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_chat_messagePanelHint));
        arrayList.add(new ThemeDescription(this.searchItem.getSearchField(), ThemeDescription.FLAG_CURSORCOLOR, (Class[]) null, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogTextBlack));
        arrayList.add(new ThemeDescription(this.scrollSlidingTextTabStrip.getTabsContainer(), ThemeDescription.FLAG_CHECKTAG | ThemeDescription.FLAG_TEXTCOLOR, new Class[]{TextView.class}, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_chat_attachActiveTab));
        arrayList.add(new ThemeDescription(this.scrollSlidingTextTabStrip.getTabsContainer(), ThemeDescription.FLAG_TEXTCOLOR | ThemeDescription.FLAG_CHECKTAG, new Class[]{TextView.class}, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_chat_attachUnactiveTab));
        arrayList.add(new ThemeDescription(this.scrollSlidingTextTabStrip.getTabsContainer(), ThemeDescription.FLAG_BACKGROUNDFILTER | ThemeDescription.FLAG_DRAWABLESELECTEDSTATE, new Class[]{TextView.class}, (Paint) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_dialogButtonSelector));
        arrayList.add(new ThemeDescription((View) null, 0, (Class[]) null, (Paint) null, new Drawable[]{this.scrollSlidingTextTabStrip.getSelectorDrawable()}, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_chat_attachActiveTab));
