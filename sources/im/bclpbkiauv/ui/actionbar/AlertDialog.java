...
public class AlertDialog extends Dialog implements Drawable.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (AlertDialog.this.topImageView != null) {
                    AlertDialog.this.topImageView.measure(View.MeasureSpec.makeMeasureSpec(width, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp((float) AlertDialog.this.topHeight), 1073741824));
                ...
                if (AlertDialog.this.lastScreenWidth != AndroidUtilities.displaySize.x) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        public final void run() {
                            AlertDialog.AnonymousClass1.this.lambda$onMeasure$0$AlertDialog$1();
                        }
                    });
                }
            }
        ...
        if (this.progressViewStyle == 0) {
            ...
            AnonymousClass2 r6 = new ScrollView(getContext()) {
                /* access modifiers changed from: protected */
        ...
        if (hasButtons) {
            ...
            if (this.positiveButtonText != null) {
                ...
                textView6.setTextColor(getThemeColor(Theme.key_dialogButton));
                ...
                textView6.setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(getThemeColor(Theme.key_dialogButton)));
