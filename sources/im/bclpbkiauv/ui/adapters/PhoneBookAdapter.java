...
public class PhoneBookAdapter extends RecyclerListView.SectionsAdapter {
    ...
    public boolean isEnabled(int section, int row) {
        return row < ContactsController.getInstance(this.currentAccount).phoneBookSectionsDict.get(ContactsController.getInstance(this.currentAccount).phoneBookSectionsArray.get(section)).size();
    }
    ...
    public int getItemViewType(int section, int position) {
        return position < ContactsController.getInstance(this.currentAccount).phoneBookSectionsDict.get(ContactsController.getInstance(this.currentAccount).phoneBookSectionsArray.get(section)).size() ? 0 : 1;
    }
