...
public class ArchiveHintInnerCell extends FrameLayout {
    ...
    public ArchiveHintInnerCell(Context context, int num) {
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chats_nameMessage_threeLines), PorterDuff.Mode.MULTIPLY));
        ...
        addView(this.headerTextView, LayoutHelper.createFrame(-1.0f, -2.0f, 51, 52.0f, 75.0f, 52.0f, 0.0f));
        TextView textView2 = new TextView(context);
        this.messageTextView = textView2;
        textView2.setTextColor(Theme.getColor(Theme.key_chats_message));
        this.messageTextView.setTextSize(1, 14.0f);
        this.messageTextView.setGravity(17);
        addView(this.messageTextView, LayoutHelper.createFrame(-1.0f, -2.0f, 51, 52.0f, 110.0f, 52.0f, 0.0f));
        if (num == 0) {
            ...
            addView(this.imageView2, LayoutHelper.createFrame(-2.0f, -2.0f, 49, 0.0f, 20.0f, 8.0f, 0.0f));
            ...
            addView(this.imageView, LayoutHelper.createFrame(-2.0f, -2.0f, 49, 0.0f, 18.0f, 0.0f, 0.0f));
