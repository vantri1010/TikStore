...
public class TextColorThemeCell extends FrameLayout {
    ...
    public TextColorThemeCell(Context context) {
        ...
        addView(this.textView, LayoutHelper.createFrame(-1.0f, -1.0f, (!LocaleController.isRTL ? 3 : i) | 48, (float) (LocaleController.isRTL ? 21 : 57), 0.0f, (float) (LocaleController.isRTL ? 57 : 21), 0.0f));
    }
