...
public class UserCell extends FrameLayout {
    ...
    public UserCell(Context context, int padding, int checkbox, boolean admin, boolean needAddButton) {
        ...
        if (needAddButton) {
            ...
            this.addButton.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable((float) AndroidUtilities.dp(4.0f), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
        ...
        addView(simpleTextView2, LayoutHelper.createFrame(-1.0f, 20.0f, i4, f, 13.5f, (float) i2, 0.0f));
        SimpleTextView simpleTextView3 = new SimpleTextView(context2);
        this.statusTextView = simpleTextView3;
        simpleTextView3.setTextSize(13);
        this.statusTextView.setGravity((LocaleController.isRTL ? 5 : 3) | 48);
        addView(this.statusTextView, LayoutHelper.createFrame(-1.0f, 20.0f, (LocaleController.isRTL ? 5 : 3) | 48, (float) (LocaleController.isRTL ? additionalPadding + 28 : padding + 64), 35.5f, (float) (LocaleController.isRTL ? padding + 64 : additionalPadding + 28), 0.0f));
    ...
    public void update(int r11) {
        ...
        L_0x0103:
            ...
            android.widget.TextView r4 = r10.adminTextView
        ...
        L_0x018d:
            ...
            java.lang.String r7 = im.bclpbkiauv.messenger.LocaleController.formatUserStatusNew(r7, r2, r4)
            r6.setText(r7)
            boolean r6 = r4[r5]
            if (r6 == 0) goto L_0x01ad
            im.bclpbkiauv.ui.actionbar.SimpleTextView r6 = r10.statusTextView
            java.lang.String r7 = "#42B71E"
        ...
        L_0x0221:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.ui.cells.UserCell.update(int):void");
    }
