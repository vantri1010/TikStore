...
public class LayoutHelper {
    ...
    public static FrameLayout.LayoutParams createFrame(int width, int height, int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(getSize((float) width), getSize((float) height));
        layoutParams.setMargins(leftMargin, topMargin, rightMargin, bottomMargin);
        return layoutParams;
    }

    public static FrameLayout.LayoutParams createFrameActionBar(int width, int height, int gravity, float topMargin, float bottomMargin) {
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(getSize((float) width), getSize((float) height), gravity);
        layoutParams.setMargins(0, ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight + AndroidUtilities.dp(topMargin), 0, AndroidUtilities.dp(bottomMargin));
        return layoutParams;
    }

    public static FrameLayout.LayoutParams createFrameWithActionBar(int width, int height) {
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(getSize((float) width), getSize((float) height));
        layoutParams.setMargins(0, ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight, 0, 0);
        return layoutParams;
    }

    public static FrameLayout.LayoutParams createFrameWithActionBarAndSearch(int width, int height, int gravity) {
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(getSize((float) width), getSize((float) height), gravity);
        layoutParams.setMargins(0, ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight + AndroidUtilities.dp(46.0f), 0, 0);
        return layoutParams;
    }

    public static FrameLayout.LayoutParams createFrameWithActionBarAndSearch(int width, int height) {
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(getSize((float) width), getSize((float) height));
        layoutParams.setMargins(0, ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight + AndroidUtilities.dp(46.0f), 0, 0);
        return layoutParams;
    }

    public static FrameLayout.LayoutParams createFrameSearchWithoutActionBar(int width, int height) {
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(getSize((float) width), getSize((float) height));
        layoutParams.setMargins(0, AndroidUtilities.dp(55.0f), 0, 0);
        return layoutParams;
    }
    ...
    public static FrameLayout.LayoutParams createFrameByPx(int width, int height, int gravity, int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
