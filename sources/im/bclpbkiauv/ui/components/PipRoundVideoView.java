...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void show(Activity activity, Runnable closeRunnable) {
        if (activity != null) {
            ...
            this.windowView.addView(this.aspectRatioFrameLayout, LayoutHelper.createFrame(120.0f, 120.0f, 51, 3.0f, 3.0f, 0.0f, 0.0f));
            ...
            this.aspectRatioFrameLayout.addView(textureView2, LayoutHelper.createFrame(-1, -1.0f));
