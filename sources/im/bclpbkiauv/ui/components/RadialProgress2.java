...
public class RadialProgress2 {
    ...
    public void setDrawRoundRect(boolean value) {
        this.drawRound = value;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mediaActionDrawable.getCurrentIcon() != 4 || this.mediaActionDrawable.getTransitionProgress() < 1.0f) {
            ...
            if (this.overlayImageView.hasBitmapImage()) {
                ...
                imageReceiver.setImageCoords(centerX - i12, centerY - i12, i12 * 2, i12 * 2);
            } else {
            ...
            if (drawCircle && this.drawBackground) {
                if (this.drawMiniIcon && (canvas3 = this.miniDrawCanvas) != null) {
                    ...
                    } else if (this.drawRound) {
                        int i15 = this.circleRadius;
                        canvas4.drawRoundRect(new RectF((float) (centerX - i15), (float) (centerY - i15), (float) (centerX + i15), (float) (i15 + centerY)), (float) AndroidUtilities.dp(5.0f), (float) AndroidUtilities.dp(5.0f), this.circleMiniPaint);
                    } else {
            ...
            mediaActionDrawable6.setBounds(centerX - i16, centerY - i16, centerX + i16, i16 + centerY);
            if (this.drawMiniIcon) {
