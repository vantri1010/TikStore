...
public class TableLayout extends View {
        ...
        public void draw(Canvas canvas) {
            ...
            if (this.cell != null) {
                ...
                if (TableLayout.this.drawLines) {
                    ...
                    int i18 = this.x;
                    if (i18 != 0 || !isLastY) {
                        start2 = ((float) this.x) - strokeWidth;
                    } else {
                        start2 = (float) (i18 + rad);
                    }
                    if (!isLastX || !isLastY) {
                        end2 = ((float) (this.x + this.measuredWidth)) - strokeWidth;
                    } else {
                        end2 = (float) ((this.x + this.measuredWidth) - rad);
                    }
                    int i19 = this.y;
    ...
    public void addChild(int x, int y, int colspan, int rowspan) {
        ...
        layoutParams.rowSpec = new Spec(false, new Interval(i2, i2 + rowspan), FILL, 0.0f);
        layoutParams.columnSpec = new Spec(false, new Interval(i, i + colspan), FILL, 0.0f);
    ...
    public void addChild(TLRPC.TL_pageTableCell cell, int x, int y, int colspan) {
        ...
        LayoutParams layoutParams = new LayoutParams();
        layoutParams.rowSpec = new Spec(false, new Interval(i2, (tL_pageTableCell.rowspan != 0 ? tL_pageTableCell.rowspan : 1) + i2), FILL, 0.0f);
        layoutParams.columnSpec = new Spec(false, new Interval(i, i + colspan2), FILL, 1.0f);
                ...
                for (int i18 = 0; i18 < size4; i18++) {
                    ...
                    if (child != next3) {
                        if (child.layoutParams.rowSpec.span.min == next3.layoutParams.rowSpec.span.min) {
                            ...
                            int unused = next3.measuredHeight = next3.measuredHeight - heightDiff;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        static {
            Interval interval = new Interval(Integer.MIN_VALUE, UVCCamera.PU_BRIGHTNESS);
