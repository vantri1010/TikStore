...
public class VideoTimelineView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.restore();
        canvas2.drawCircle((float) startX, (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.dp(7.0f), this.paint);
        canvas2.drawCircle((float) (AndroidUtilities.dp(4.0f) + endX), (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.dp(7.0f), this.paint);
    }
}
