...
public class BannerConfig {
    ...
    public static final float INDICATOR_HEIGHT = BannerUtils.dp2px(3.0f);
    ...
    public static final float INDICATOR_RADIUS = BannerUtils.dp2px(3.0f);
    public static final int INDICATOR_SELECTED_COLOR = -2013265920;
    public static final float INDICATOR_SELECTED_WIDTH = BannerUtils.dp2px(7.0f);
