...
public class CreateSecureAdapter extends RecyclerListView.SectionsAdapter {
    ...
    public CreateSecureAdapter(Context context) {
            ...
            try {
                ...
                Collections.sort(this.onlineContacts, new Comparator(currentTime) {
                    ...
                    public final int compare(Object obj, Object obj2) {
                        return CreateSecureAdapter.lambda$sortOnlineContacts$0(MessagesController.this, this.f$1, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                    }
                });
                notifyDataSetChanged();
            } catch (Exception e) {
