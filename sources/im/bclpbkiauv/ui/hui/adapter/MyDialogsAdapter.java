...
import im.bclpbkiauv.ui.hcells.MyDialogsEmptyCell;
...
public class MyDialogsAdapter extends RecyclerListView.SelectionAdapter {
            ...
            try {
                ...
                Collections.sort(this.onlineContacts, new Comparator(currentTime) {
                    ...
                    public final int compare(Object obj, Object obj2) {
                        return MyDialogsAdapter.lambda$sortOnlineContacts$0(MessagesController.this, this.f$1, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                    }
                });
                if (notify) {
                    notifyDataSetChanged();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (i) {
            case 0:
                AnonymousClass1 r6 = new SwipeLayout(this.mContext) {
            ...
            case 2:
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    public final void onClick(View view) {
                        MyDialogsAdapter.this.lambda$onCreateViewHolder$1$MyDialogsAdapter(view);
                    }
                });
                ...
                break;
            case 3:
                AnonymousClass2 r5 = new FrameLayout(this.mContext) {
                ...
                r5.addView(new View(this.mContext), LayoutHelper.createFrame(-1, -1.0f));
                AnonymousClass2 r7 = r5;
                view = r5;
                break;
            case 4:
                ...
                break;
            case 5:
                view = new MyDialogsEmptyCell(this.mContext);
                break;
            case 6:
            ...
            case 7:
                ...
                headerCell3.setText(LocaleController.getString("YourContacts", R.string.YourContacts));
                HeaderCell headerCell4 = headerCell3;
                view = headerCell3;
                break;
            case 8:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
        ...
        if (itemViewType == 0) {
            ...
            DialogCell cell = (DialogCell) swipeLayout.getMainLayout();
            ...
            if (this.folderId == 0) {
                ...
                if (getItemCount() == 2) {
                    swipeLayout.setBackground(Theme.createRoundRectDrawable((float) AndroidUtilities.dp(5.0f), Theme.getColor(Theme.key_windowBackgroundWhite)));
                } else if (i == 0) {
                    swipeLayout.setBackground(Theme.createRoundRectDrawable((float) AndroidUtilities.dp(5.0f), (float) AndroidUtilities.dp(5.0f), 0.0f, 0.0f, Theme.getColor(Theme.key_windowBackgroundWhite)));
                } else if (i == getItemCount() - 2) {
                    swipeLayout.setBackground(Theme.createRoundRectDrawable(0.0f, 0.0f, (float) AndroidUtilities.dp(5.0f), (float) AndroidUtilities.dp(5.0f), Theme.getColor(Theme.key_windowBackgroundWhite)));
                }
            } else {
