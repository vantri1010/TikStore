...
public class SelectContactsAdapter extends RecyclerListView.SectionsAdapter {
            ...
            try {
                ...
                Collections.sort(this.onlineContacts, new Comparator(currentTime) {
                    ...
                    public final int compare(Object obj, Object obj2) {
                        return SelectContactsAdapter.lambda$sortOnlineContacts$0(MessagesController.this, this.f$1, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                    }
                });
                notifyDataSetChanged();
            } catch (Exception e) {
    ...
    public void onBindViewHolder(int section, int position, RecyclerView.ViewHolder holder) {
        ...
        if (itemViewType == 0) {
            ...
            TLRPC.User user = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(ContactsController.getInstance(this.currentAccount).usersSectionsDict.get(ContactsController.getInstance(this.currentAccount).sortedUsersSectionsArray.get(section - 1)).get(i).user_id));
            userCell.setData(user, (CharSequence) null, (CharSequence) null, 0, i != getItemCount() - 1);
            ...
            IndexTextCell textCell = (IndexTextCell) viewHolder.itemView;
            ContactsController.Contact contact = ContactsController.getInstance(this.currentAccount).phoneBookContacts.get(i);
