...
import im.bclpbkiauv.ui.hui.friendscircle_v1.player.view.AbsVideoPlayerView;
...
public class FullScreenExoPlayer extends Dialog {
    ...
    public FullScreenExoPlayer(android.content.Context r17, im.bclpbkiauv.ui.hui.friendscircle_v1.player.view.AbsVideoPlayerView r18, float r19, boolean r20, java.lang.String r21, im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer.dismissListener r22) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
            ...
            im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$UfaLsfWMsGtfj28ptsWNyLo12A4 r5 = new im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$UfaLsfWMsGtfj28ptsWNyLo12A4
            r5.<init>()
        ...
        L_0x00bc:
            ...
            im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$RF4EjMQeccHXdrjyKEuuJC5_1p0 r12 = new im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$RF4EjMQeccHXdrjyKEuuJC5_1p0
            r12.<init>()
            r4.setOnClickListener(r12)
            android.widget.ImageView r4 = r0.iv_play
            im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$QXGZr-aSjw24msQRPJQe2szaOF0 r12 = new im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$QXGZr-aSjw24msQRPJQe2szaOF0
            r12.<init>()
            r4.setOnClickListener(r12)
            android.widget.ImageView r4 = r0.iv_mute
            im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$0Ur4bkRRJ1RriPEA9sXIFyct7Go r12 = new im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$0Ur4bkRRJ1RriPEA9sXIFyct7Go
            r12.<init>()
            r4.setOnClickListener(r12)
            im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$eIRQZYPxeIIkMxTav3PTQRKFLug r4 = new im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$eIRQZYPxeIIkMxTav3PTQRKFLug
            r4.<init>(r1)
        ...
        L_0x011d:
            ...
            im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer$1 r12 = new im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer$1
            r12.<init>(r3)
            r4.setOnClickListener(r12)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer.<init>(android.content.Context, im.bclpbkiauv.ui.hui.friendscircle_v1.player.view.AbsVideoPlayerView, float, boolean, java.lang.String, im.bclpbkiauv.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer$dismissListener):void");
    }

    public /* synthetic */ void lambda$new$0$FullScreenExoPlayer(View v) {
    ...
    public /* synthetic */ void lambda$new$1$FullScreenExoPlayer(View v) {
    ...
    public /* synthetic */ void lambda$new$2$FullScreenExoPlayer(View v) {
        if (this.blnMute) {
    ...
    private void createSeekBar(final AbsVideoPlayerView player) {
        ...
        AnonymousClass3 r0 = new FrameLayout(getContext()) {
            public boolean onTouchEvent(MotionEvent event) {
                ...
                if (!FullScreenExoPlayer.this.videoPlayerSeekbar.onTouchNew(event.getAction(), event.getX(), event.getY())) {
                    return true;
                }
