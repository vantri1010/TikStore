...
public class ChangePersonalInformationActivity_ViewBinding implements Unbinder {
    ...
    public ChangePersonalInformationActivity_ViewBinding(final ChangePersonalInformationActivity target2, View source) {
        ...
        View view2 = Utils.findRequiredView(source, R.id.selectSexParent, "field 'selectSexParent' and method 'onClick'");
        target2.selectSexParent = view2;
        this.view7f090400 = view2;
        view2.setOnClickListener(new DebouncingOnClickListener() {
            public void doClick(View p0) {
                target2.onClick(p0);
            }
        });
        View view3 = Utils.findRequiredView(source, R.id.containerMale, "field 'containerMale' and method 'onClick'");
        target2.containerMale = view3;
        this.view7f0900e8 = view3;
        ...
        View view4 = Utils.findRequiredView(source, R.id.containerFemale, "field 'containerFemale' and method 'onClick'");
        target2.containerFemale = view4;
        this.view7f0900e4 = view4;
        ...
        target2.tvSelectSex = (MryTextView) Utils.findRequiredViewAsType(source, R.id.tvSelectSex, "field 'tvSelectSex'", MryTextView.class);
        target2.tvFemale = (MryTextView) Utils.findRequiredViewAsType(source, R.id.tvFemale, "field 'tvFemale'", MryTextView.class);
        target2.tvSelectDateOfBirth = (MryTextView) Utils.findRequiredViewAsType(source, R.id.tvSelectDateOfBirth, "field 'tvSelectDateOfBirth'", MryTextView.class);
        View view5 = Utils.findRequiredView(source, R.id.tvDate, "field 'tvDate' and method 'onClick'");
        target2.tvDate = (MryTextView) Utils.castView(view5, R.id.tvDate, "field 'tvDate'", MryTextView.class);
        this.view7f0904c5 = view5;
        ...
        View view6 = Utils.findRequiredView(source, R.id.btnDone, "field 'btnDone' and method 'onClick'");
        target2.btnDone = (MryRoundButton) Utils.castView(view6, R.id.btnDone, "field 'btnDone'", MryRoundButton.class);
        this.view7f09009b = view6;
    ...
    public void unbind() {
        ...
        if (target2 != null) {
            ...
            this.view7f090400.setOnClickListener((View.OnClickListener) null);
            ...
            this.view7f0904c5.setOnClickListener((View.OnClickListener) null);
