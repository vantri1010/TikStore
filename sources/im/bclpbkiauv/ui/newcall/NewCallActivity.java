...
import im.bclpbkiauv.ui.newcall.NewCallActivity;
...
public class NewCallActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (visibleItemCount > 0) {
                    ...
                    if (!NewCallActivity.this.endReached && !NewCallActivity.this.loading && !NewCallActivity.this.calls.isEmpty() && firstVisibleItem + visibleItemCount >= totalItemCount - 5) {
                        AndroidUtilities.runOnUIThread(new Runnable((CallLogRow) NewCallActivity.this.calls.get(NewCallActivity.this.calls.size() - 1)) {
                            private final /* synthetic */ NewCallActivity.CallLogRow f$1;
                            ...
                            public final void run() {
                                NewCallActivity.AnonymousClass1.this.lambda$onScrolled$0$NewCallActivity$1(this.f$1);
                            }
                        });
                    }
                }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_all_call /*2131297717*/:
                ...
                return;
            case R.id.tv_cancel_call /*2131297731*/:
                if (this.m_tvCurrent.getId() != v.getId()) {
                    changeTabState(v);
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            CallLogRow row = (CallLogRow) NewCallActivity.this.calls.get(i);
            ...
            viewHolder.itemView.findViewById(R.id.iv_more).setOnClickListener(new View.OnClickListener(row) {
                ...
                public final void onClick(View view) {
                    NewCallActivity.ListAdapter.this.lambda$onBindViewHolder$0$NewCallActivity$ListAdapter(this.f$1, view);
                }
            });
            ...
            ((TextView) viewHolder.itemView.findViewById(R.id.btnDelete)).setOnClickListener(new View.OnClickListener(i, row) {
                ...
                private final /* synthetic */ NewCallActivity.CallLogRow f$2;
                ...
                public final void onClick(View view) {
                    NewCallActivity.ListAdapter.this.lambda$onBindViewHolder$2$NewCallActivity$ListAdapter(this.f$1, this.f$2, view);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onBindViewHolder$2$NewCallActivity$ListAdapter(int position, CallLogRow row, View v) {
            if (position >= 0 && position < NewCallActivity.this.calls.size()) {
                CallLogRow callLogRow = (CallLogRow) NewCallActivity.this.calls.get(position);
                ...
                new AlertDialog.Builder((Context) NewCallActivity.this.getParentActivity()).setTitle(LocaleController.getString("Calls", R.string.Calls)).setItems((CharSequence[]) items.toArray(new String[0]), new DialogInterface.OnClickListener(row, callLogRow) {
                    private final /* synthetic */ NewCallActivity.CallLogRow f$1;
                    private final /* synthetic */ NewCallActivity.CallLogRow f$2;
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        NewCallActivity.ListAdapter.this.lambda$null$1$NewCallActivity$ListAdapter(this.f$1, this.f$2, dialogInterface, i);
                    }
                }).show();
            }
        }
    ...
    public /* synthetic */ void lambda$getCalls$2$NewCallActivity(TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new Runnable(error, response) {
            ...
            public final void run() {
                NewCallActivity.this.lambda$null$1$NewCallActivity(this.f$1, this.f$2);
            }
        });
    }
    ...
    public void confirmAndDelete(CallLogRow row) {
        if (getParentActivity() != null) {
            new AlertDialog.Builder((Context) getParentActivity()).setTitle(LocaleController.getString("AppName", R.string.AppName)).setMessage(LocaleController.getString("ConfirmDeleteCallLog", R.string.ConfirmDeleteCallLog)).setPositiveButton(LocaleController.getString("Delete", R.string.Delete), new DialogInterface.OnClickListener(row) {
                ...
                public final void onClick(DialogInterface dialogInterface, int i) {
                    NewCallActivity.this.lambda$confirmAndDelete$3$NewCallActivity(this.f$1, dialogInterface, i);
                }
    ...
    private void showAlert(TLRPC.User user) {
        ...
        new DialogCommonList((Activity) getParentActivity(), list, list1, Color.parseColor("#222222"), (DialogCommonList.RecyclerviewItemClickCallBack) new DialogCommonList.RecyclerviewItemClickCallBack(user) {
            ...
            public final void onRecyclerviewItemClick(int i) {
                NewCallActivity.this.lambda$showAlert$4$NewCallActivity(this.f$1, i);
            }
        }, 1).show();
    }
    ...
    public /* synthetic */ void lambda$new$6$NewCallActivity(View v) {
        ...
        list1.add(Integer.valueOf(R.drawable.menu_voice_call));
        list1.add(Integer.valueOf(R.drawable.menu_video_call));
        new DialogCommonList((Activity) getParentActivity(), list, list1, Color.parseColor("#222222"), (DialogCommonList.RecyclerviewItemClickCallBack) new DialogCommonList.RecyclerviewItemClickCallBack((CallLogRow) v.getTag()) {
            private final /* synthetic */ NewCallActivity.CallLogRow f$1;
            ...
            public final void onRecyclerviewItemClick(int i) {
                NewCallActivity.this.lambda$null$5$NewCallActivity(this.f$1, i);
            }
        }, 1).show();
    }
