package im.bclpbkiauv.ui.wallet.dialogs;
...
public abstract class WalletSelect1LineDialog<T> extends WalletSelectAbsDialog<T, WalletSelect1LineDialog, Holder1Line> {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [im.bclpbkiauv.ui.dialogs.WalletSelectAbsDialog$OnConfirmClickListener, im.bclpbkiauv.ui.dialogs.WalletSelectAbsDialog$OnConfirmClickListener<T, im.bclpbkiauv.ui.wallet.dialogs.WalletSelect1LineDialog>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public im.bclpbkiauv.ui.wallet.dialogs.WalletSelect1LineDialog setOnConfrimClickListener(im.bclpbkiauv.ui.dialogs.WalletSelectAbsDialog.OnConfirmClickListener<T, im.bclpbkiauv.ui.wallet.dialogs.WalletSelect1LineDialog> r2) {
        /*
            r1 = this;
            im.bclpbkiauv.ui.dialogs.WalletSelectAbsDialog r0 = super.setOnConfrimClickListener(r2)
            im.bclpbkiauv.ui.wallet.dialogs.WalletSelect1LineDialog r0 = (im.bclpbkiauv.ui.wallet.dialogs.WalletSelect1LineDialog) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: im.bclpbkiauv.ui.wallet.dialogs.WalletSelect1LineDialog.setOnConfrimClickListener(im.bclpbkiauv.ui.dialogs.WalletSelectAbsDialog$OnConfirmClickListener):im.bclpbkiauv.ui.wallet.dialogs.WalletSelect1LineDialog");
    }
