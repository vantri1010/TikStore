...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static boolean m143equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual((Object) iArr, (Object) ((UIntArray) obj).m154unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m144equalsimpl0(int[] iArr, int[] iArr2) {
    ...
    public static int m147hashCodeimpl(int[] iArr) {
        if (iArr != null) {
    ...
    public static String m151toStringimpl(int[] iArr) {
    ...
    public boolean m152addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean m153containsWZ4Q5Ns(int i) {
        return m141containsWZ4Q5Ns(this.storage, i);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m153containsWZ4Q5Ns(((UInt) obj).m137unboximpl());
        }
        return false;
    }
    ...
    public static int[] m140constructorimpl(int[] storage2) {
        Intrinsics.checkParameterIsNotNull(storage2, "storage");
        return storage2;
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int[] m139constructorimpl(int size) {
        return m140constructorimpl(new int[size]);
    }

    /* renamed from: get-impl  reason: not valid java name */
    public static final int m145getimpl(int[] $this, int index) {
        return UInt.m94constructorimpl($this[index]);
    }

    /* renamed from: set-VXSXFK8  reason: not valid java name */
    public static final void m150setVXSXFK8(int[] $this, int index, int value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m146getSizeimpl(int[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static UIntIterator m149iteratorimpl(int[] $this) {
    ...
    private static final class Iterator extends UIntIterator {
        ...
        public int nextUInt() {
            ...
            if (i < iArr.length) {
                this.index = i + 1;
                return UInt.m94constructorimpl(iArr[i]);
            }
    ...
    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public static boolean m141containsWZ4Q5Ns(int[] $this, int element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m142containsAllimpl(int[] $this, Collection<UInt> elements) {
        boolean z;
        ...
        for (Object it : $this$all$iv) {
            if (!(it instanceof UInt) || !ArraysKt.contains($this, ((UInt) it).m137unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
    ...
    public static boolean m148isEmptyimpl(int[] $this) {
