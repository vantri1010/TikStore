...
public final class UnsignedKt {
    ...
    public static final int m320uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m94constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m321uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m94constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m322ulongDivideeb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m163constructorimpl(j);
        } else if (dividend >= 0) {
            return ULong.m163constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (ulongCompare(ULong.m163constructorimpl(dividend - (quotient * divisor)), ULong.m163constructorimpl(divisor)) < 0) {
                i = 0;
            }
            return ULong.m163constructorimpl(((long) i) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m323ulongRemaindereb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m163constructorimpl(v1 - v2);
        } else if (dividend >= 0) {
            return ULong.m163constructorimpl(dividend % divisor);
        } else {
            long rem = dividend - ((((dividend >>> 1) / divisor) << 1) * divisor);
            if (ulongCompare(ULong.m163constructorimpl(rem), ULong.m163constructorimpl(divisor)) >= 0) {
                j = divisor;
            }
            return ULong.m163constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= d) {
            return UInt.m94constructorimpl((int) v);
        }
        return UInt.m94constructorimpl(UInt.m94constructorimpl((int) (v - d)) + UInt.m94constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < ((double) Long.MAX_VALUE)) {
            return ULong.m163constructorimpl((long) v);
        }
        return ULong.m163constructorimpl(ULong.m163constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
