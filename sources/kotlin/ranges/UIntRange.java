...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m886containsWZ4Q5Ns(((UInt) comparable).m137unboximpl());
    }

    public UInt getStart() {
        return UInt.m88boximpl(getFirst());
    }

    public UInt getEndInclusive() {
        return UInt.m88boximpl(getLast());
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m886containsWZ4Q5Ns(int value) {
    ...
    public String toString() {
        return UInt.m131toStringimpl(getFirst()) + ".." + UInt.m131toStringimpl(getLast());
    }
