...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m888containsVKZWuLQ(((ULong) comparable).m206unboximpl());
    }

    public ULong getStart() {
        return ULong.m157boximpl(getFirst());
    }

    public ULong getEndInclusive() {
        return ULong.m157boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m888containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m163constructorimpl(getLast() ^ ULong.m163constructorimpl(getLast() >>> 32))) + (((int) ULong.m163constructorimpl(getFirst() ^ ULong.m163constructorimpl(getFirst() >>> 32))) * 31);
    }

    public String toString() {
        return ULong.m200toStringimpl(getFirst()) + ".." + ULong.m200toStringimpl(getLast());
    }
