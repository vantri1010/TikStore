...
public abstract class AbstractDoubleClock implements Clock {
    ...
    private static final class DoubleClockMark extends ClockMark {
        ...
        public double elapsedNow() {
            return Duration.m957minusLRDsOJo(DurationKt.toDuration(this.clock.read() - this.startedAt, this.clock.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ClockMark m927plusLRDsOJo(double duration) {
            return new DoubleClockMark(this.startedAt, this.clock, Duration.m958plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
