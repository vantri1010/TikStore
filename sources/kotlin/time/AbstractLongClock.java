...
public abstract class AbstractLongClock implements Clock {
    ...
    private static final class LongClockMark extends ClockMark {
        ...
        public ClockMark m928plusLRDsOJo(double duration) {
            return new LongClockMark(this.startedAt, this.clock, Duration.m958plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
