...
final class AdjustedClockMark extends ClockMark {
    ...
    public double elapsedNow() {
        return Duration.m957minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public ClockMark m929plusLRDsOJo(double duration) {
        return new AdjustedClockMark(this.mark, Duration.m958plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
