...
public abstract class ClockMark {
    ...
    public ClockMark m931plusLRDsOJo(double duration) {
        return new AdjustedClockMark(this, duration, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public ClockMark m930minusLRDsOJo(double duration) {
        return m931plusLRDsOJo(Duration.m975unaryMinusimpl(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m955isNegativeimpl(elapsedNow());
    }
