...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m982copyRFiDyg4$default(TimedValue timedValue, T t, double d, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m983copyRFiDyg4(t, d);
    }
    ...
    public final TimedValue<T> m983copyRFiDyg4(T t, double d) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m972toStringimpl(this.duration) + SQLBuilder.PARENTHESES_RIGHT;
    }
