...
public final class ConnectionSpec {
    ...
    public String toString() {
        ...
        return "ConnectionSpec(cipherSuites=" + cipherSuitesString + ", tlsVersions=" + tlsVersionsString + ", supportsTlsExtensions=" + this.supportsTlsExtensions + SQLBuilder.PARENTHESES_RIGHT;
    }
