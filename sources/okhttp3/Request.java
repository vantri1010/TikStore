...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder head() {
            return method(OkHttpUtils.METHOD.HEAD, (RequestBody) null);
        }
        ...
        public Builder delete(@Nullable RequestBody body2) {
            return method(OkHttpUtils.METHOD.DELETE, body2);
        }
        ...
        public Builder put(RequestBody body2) {
            return method(OkHttpUtils.METHOD.PUT, body2);
        }

        public Builder patch(RequestBody body2) {
            return method(OkHttpUtils.METHOD.PATCH, body2);
        }
