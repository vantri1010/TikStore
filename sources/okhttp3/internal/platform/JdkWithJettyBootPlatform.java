    ...
    private static class JettyNegoProvider implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (methodName.equals("unsupported") && Void.TYPE == returnType) {
                ...
                if ((methodName.equals("selectProtocol") || methodName.equals(WalletWithdrawTemplateBean.TYPE_SELECT)) && String.class == returnType && args.length == 1 && (args[0] instanceof List)) {
