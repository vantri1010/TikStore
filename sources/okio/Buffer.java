...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (this.size != 0) {
            ...
            throw new EOFException("size < " + byteCount + ": " + this.size + " (to read code point prefixed 0x" + Integer.toHexString(b0) + SQLBuilder.PARENTHESES_RIGHT);
        }
        throw new EOFException();
    }
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        if (v < 100000000) {
            width = v < OkHttpUtils.DEFAULT_MILLISECONDS ? v < 100 ? v < 10 ? 1 : 2 : v < 1000 ? 3 : 4 : v < 1000000 ? v < 100000 ? 5 : 6 : v < 10000000 ? 7 : 8;
        } else if (v < 1000000000000L) {
            width = v < 10000000000L ? v < C.NANOS_PER_SECOND ? 9 : 10 : v < 100000000000L ? 11 : 12;
