...
public final class Factory {
    ...
    public MethodSignature makeMethodSig(String modifiers, String methodName, String declaringType, String paramTypes, String paramNames, String exceptionTypes, String returnType) {
        ...
        StringTokenizer st = new StringTokenizer(paramTypes, LogUtils.COLON);
        ...
        StringTokenizer st2 = new StringTokenizer(paramNames, LogUtils.COLON);
        ...
        StringTokenizer st3 = new StringTokenizer(exceptionTypes, LogUtils.COLON);
    ...
    public CatchClauseSignature makeCatchClauseSig(String declaringType, String parameterType, String parameterName) {
        CatchClauseSignatureImpl ret = new CatchClauseSignatureImpl(makeClass(declaringType, this.lookupClassLoader), makeClass(new StringTokenizer(parameterType, LogUtils.COLON).nextToken(), this.lookupClassLoader), new StringTokenizer(parameterName, LogUtils.COLON).nextToken());
        ret.setLookupClassLoader(this.lookupClassLoader);
        return ret;
    }
