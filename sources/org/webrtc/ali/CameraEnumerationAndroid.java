...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size[]{new Size(160, 120), new Size(PsExtractor.VIDEO_STREAM_MASK, 160), new Size(320, PsExtractor.VIDEO_STREAM_MASK), new Size(400, PsExtractor.VIDEO_STREAM_MASK), new Size(UVCCamera.DEFAULT_PREVIEW_HEIGHT, 320), new Size(UVCCamera.DEFAULT_PREVIEW_WIDTH, 360), new Size(UVCCamera.DEFAULT_PREVIEW_WIDTH, UVCCamera.DEFAULT_PREVIEW_HEIGHT), new Size(768, UVCCamera.DEFAULT_PREVIEW_HEIGHT), new Size(854, UVCCamera.DEFAULT_PREVIEW_HEIGHT), new Size(CodeUtils.DEFAULT_REQ_HEIGHT, BannerConfig.SCROLL_TIME), new Size(960, 540), new Size(960, UVCCamera.DEFAULT_PREVIEW_WIDTH), new Size(1024, 576), new Size(1024, BannerConfig.SCROLL_TIME), new Size(1280, 720), new Size(1280, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)}));
    ...
    public static class CaptureFormat {
        ...
        public static class FramerateRange {
            ...
            public String toString() {
                return "[" + (((float) this.min) / 1000.0f) + LogUtils.COLON + (((float) this.max) / 1000.0f) + "]";
            }
