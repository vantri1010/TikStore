...
final class ServiceMethod<R, T> {
    ...
    public Request toRequest(@Nullable Object... args) throws IOException {
        ...
        throw new IllegalArgumentException("Argument count (" + argumentCount + ") doesn't match expected count (" + parameterHandlerArr.length + SQLBuilder.PARENTHESES_RIGHT);
    }
    ...
    static final class Builder<T, R> {
        ...
        private RuntimeException parameterError(Throwable cause, int p, String message, Object... args) {
            return methodError(cause, message + " (parameter #" + (p + 1) + SQLBuilder.PARENTHESES_RIGHT, args);
        }

        private RuntimeException parameterError(int p, String message, Object... args) {
            return methodError(message + " (parameter #" + (p + 1) + SQLBuilder.PARENTHESES_RIGHT, args);
        }
    }
